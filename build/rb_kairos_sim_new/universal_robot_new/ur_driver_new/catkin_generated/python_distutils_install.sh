...
echo_and_run cd "/home/adi/Downloads/GazeboSimulation/src/rb_kairos_sim_new/universal_robot_new/ur_driver_new"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/adi/Downloads/GazeboSimulation/src/rb_kairos_sim_new/universal_robot_new/ur_driver_new/setup.py" \
     \
    build --build-base "/home/adi/Downloads/GazeboSimulation/build/rb_kairos_sim_new/universal_robot_new/ur_driver_new" \
    install \
    --root="${DESTDIR-/}" \
