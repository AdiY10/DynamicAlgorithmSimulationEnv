...
(cl:defmethod cl:initialize-instance :after ((m <SetElevatorFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetElevatorFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotnik_msgs_new-msg:<SetElevatorFeedback> is deprecated: use robotnik_msgs_new-msg:SetElevatorFeedback instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetElevatorFeedback>)))
  ...
  "robotnik_msgs_new/SetElevatorFeedback")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetElevatorFeedback)))
  "Returns string type for a message object of type 'SetElevatorFeedback"
  "robotnik_msgs_new/SetElevatorFeedback")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SetElevatorFeedback>)))
  ...
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%robotnik_msgs_new/ElevatorStatus status~%~%~%================================================================================~%MSG: robotnik_msgs_new/ElevatorStatus~%# state~%string RAISING=raising~%string LOWERING=lowering~%string IDLE=idle~%string ERROR_G_IO=error_getting_io~%string ERROR_S_IO=error_setting_io~%string ERROR_TIMEOUT=error_timeout_in_action~%# position~%string UP=up~%string DOWN=down~%string UNKNOWN=unknown~%# IDLE, RAISING, LOWERING~%string state~%# UP, DOWN, UNKNOWN~%string position~%float32 height~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SetElevatorFeedback)))
  "Returns full string definition for message of type 'SetElevatorFeedback"
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%robotnik_msgs_new/ElevatorStatus status~%~%~%================================================================================~%MSG: robotnik_msgs_new/ElevatorStatus~%# state~%string RAISING=raising~%string LOWERING=lowering~%string IDLE=idle~%string ERROR_G_IO=error_getting_io~%string ERROR_S_IO=error_setting_io~%string ERROR_TIMEOUT=error_timeout_in_action~%# position~%string UP=up~%string DOWN=down~%string UNKNOWN=unknown~%# IDLE, RAISING, LOWERING~%string state~%# UP, DOWN, UNKNOWN~%string position~%float32 height~%~%~%"))
