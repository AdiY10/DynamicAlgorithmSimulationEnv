...
(cl:defmethod cl:initialize-instance :after ((m <Axis>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Axis)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotnik_msgs_new-msg:<Axis> is deprecated: use robotnik_msgs_new-msg:Axis instead.")))

(cl:ensure-generic-function 'pan-val :lambda-list '(m))
(cl:defmethod pan-val ((m <Axis>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:pan-val is deprecated.  Use robotnik_msgs_new-msg:pan instead.")
  (pan m))

(cl:ensure-generic-function 'tilt-val :lambda-list '(m))
(cl:defmethod tilt-val ((m <Axis>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:tilt-val is deprecated.  Use robotnik_msgs_new-msg:tilt instead.")
  (tilt m))

(cl:ensure-generic-function 'zoom-val :lambda-list '(m))
(cl:defmethod zoom-val ((m <Axis>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:zoom-val is deprecated.  Use robotnik_msgs_new-msg:zoom instead.")
  (zoom m))

(cl:ensure-generic-function 'focus-val :lambda-list '(m))
(cl:defmethod focus-val ((m <Axis>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:focus-val is deprecated.  Use robotnik_msgs_new-msg:focus instead.")
  (focus m))

(cl:ensure-generic-function 'brightness-val :lambda-list '(m))
(cl:defmethod brightness-val ((m <Axis>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:brightness-val is deprecated.  Use robotnik_msgs_new-msg:brightness instead.")
  (brightness m))

(cl:ensure-generic-function 'iris-val :lambda-list '(m))
(cl:defmethod iris-val ((m <Axis>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:iris-val is deprecated.  Use robotnik_msgs_new-msg:iris instead.")
  (iris m))

(cl:ensure-generic-function 'autofocus-val :lambda-list '(m))
(cl:defmethod autofocus-val ((m <Axis>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:autofocus-val is deprecated.  Use robotnik_msgs_new-msg:autofocus instead.")
  (autofocus m))

(cl:ensure-generic-function 'autoiris-val :lambda-list '(m))
(cl:defmethod autoiris-val ((m <Axis>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:autoiris-val is deprecated.  Use robotnik_msgs_new-msg:autoiris instead.")
  (autoiris m))
