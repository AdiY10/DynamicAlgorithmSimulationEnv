...
(cl:defmethod cl:initialize-instance :after ((m <ElevatorAction>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ElevatorAction)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotnik_msgs_new-msg:<ElevatorAction> is deprecated: use robotnik_msgs_new-msg:ElevatorAction instead.")))

(cl:ensure-generic-function 'action-val :lambda-list '(m))
(cl:defmethod action-val ((m <ElevatorAction>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:action-val is deprecated.  Use robotnik_msgs_new-msg:action instead.")
  (action m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ElevatorAction>)))
  ...
  "robotnik_msgs_new/ElevatorAction")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ElevatorAction)))
  "Returns string type for a message object of type 'ElevatorAction"
  "robotnik_msgs_new/ElevatorAction")
