...
(cl:defmethod cl:initialize-instance :after ((m <BoolArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BoolArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotnik_msgs_new-msg:<BoolArray> is deprecated: use robotnik_msgs_new-msg:BoolArray instead.")))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <BoolArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:data-val is deprecated.  Use robotnik_msgs_new-msg:data instead.")
  (data m))
