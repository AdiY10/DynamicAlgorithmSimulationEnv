...
(cl:defmethod cl:initialize-instance :after ((m <QueryAlarm>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'QueryAlarm)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotnik_msgs_new-msg:<QueryAlarm> is deprecated: use robotnik_msgs_new-msg:QueryAlarm instead.")))

(cl:ensure-generic-function 'alm_id-val :lambda-list '(m))
(cl:defmethod alm_id-val ((m <QueryAlarm>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:alm_id-val is deprecated.  Use robotnik_msgs_new-msg:alm_id instead.")
  (alm_id m))

(cl:ensure-generic-function 'alm_component-val :lambda-list '(m))
(cl:defmethod alm_component-val ((m <QueryAlarm>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:alm_component-val is deprecated.  Use robotnik_msgs_new-msg:alm_component instead.")
  (alm_component m))

(cl:ensure-generic-function 'alm_type-val :lambda-list '(m))
(cl:defmethod alm_type-val ((m <QueryAlarm>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:alm_type-val is deprecated.  Use robotnik_msgs_new-msg:alm_type instead.")
  (alm_type m))

(cl:ensure-generic-function 'alm_group-val :lambda-list '(m))
(cl:defmethod alm_group-val ((m <QueryAlarm>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:alm_group-val is deprecated.  Use robotnik_msgs_new-msg:alm_group instead.")
  (alm_group m))

(cl:ensure-generic-function 'alm_description-val :lambda-list '(m))
(cl:defmethod alm_description-val ((m <QueryAlarm>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:alm_description-val is deprecated.  Use robotnik_msgs_new-msg:alm_description instead.")
  (alm_description m))

(cl:ensure-generic-function 'alm_start_time-val :lambda-list '(m))
(cl:defmethod alm_start_time-val ((m <QueryAlarm>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:alm_start_time-val is deprecated.  Use robotnik_msgs_new-msg:alm_start_time instead.")
  (alm_start_time m))

(cl:ensure-generic-function 'alm_end_time-val :lambda-list '(m))
(cl:defmethod alm_end_time-val ((m <QueryAlarm>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:alm_end_time-val is deprecated.  Use robotnik_msgs_new-msg:alm_end_time instead.")
  (alm_end_time m))
