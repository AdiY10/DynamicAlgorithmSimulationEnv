...
(cl:defmethod cl:initialize-instance :after ((m <alarmmonitor>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'alarmmonitor)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotnik_msgs_new-msg:<alarmmonitor> is deprecated: use robotnik_msgs_new-msg:alarmmonitor instead.")))

(cl:ensure-generic-function 'type-val :lambda-list '(m))
(cl:defmethod type-val ((m <alarmmonitor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:type-val is deprecated.  Use robotnik_msgs_new-msg:type instead.")
  (type m))

(cl:ensure-generic-function 'display-val :lambda-list '(m))
(cl:defmethod display-val ((m <alarmmonitor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:display-val is deprecated.  Use robotnik_msgs_new-msg:display instead.")
  (display m))

(cl:ensure-generic-function 'component-val :lambda-list '(m))
(cl:defmethod component-val ((m <alarmmonitor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:component-val is deprecated.  Use robotnik_msgs_new-msg:component instead.")
  (component m))

(cl:ensure-generic-function 'hmi-val :lambda-list '(m))
(cl:defmethod hmi-val ((m <alarmmonitor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:hmi-val is deprecated.  Use robotnik_msgs_new-msg:hmi instead.")
  (hmi m))

(cl:ensure-generic-function 'group-val :lambda-list '(m))
(cl:defmethod group-val ((m <alarmmonitor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:group-val is deprecated.  Use robotnik_msgs_new-msg:group instead.")
  (group m))

(cl:ensure-generic-function 'text-val :lambda-list '(m))
(cl:defmethod text-val ((m <alarmmonitor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:text-val is deprecated.  Use robotnik_msgs_new-msg:text instead.")
  (text m))

(cl:ensure-generic-function 'seconds_active-val :lambda-list '(m))
(cl:defmethod seconds_active-val ((m <alarmmonitor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:seconds_active-val is deprecated.  Use robotnik_msgs_new-msg:seconds_active instead.")
  (seconds_active m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<alarmmonitor>)))
  ...
  "robotnik_msgs_new/alarmmonitor")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'alarmmonitor)))
  "Returns string type for a message object of type 'alarmmonitor"
  "robotnik_msgs_new/alarmmonitor")
