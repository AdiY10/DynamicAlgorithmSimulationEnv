...
(cl:defmethod cl:initialize-instance :after ((m <Pose2DArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Pose2DArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotnik_msgs_new-msg:<Pose2DArray> is deprecated: use robotnik_msgs_new-msg:Pose2DArray instead.")))

(cl:ensure-generic-function 'poses-val :lambda-list '(m))
(cl:defmethod poses-val ((m <Pose2DArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:poses-val is deprecated.  Use robotnik_msgs_new-msg:poses instead.")
  (poses m))
