...
(cl:defmethod cl:initialize-instance :after ((m <BatteryStatus>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BatteryStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotnik_msgs_new-msg:<BatteryStatus> is deprecated: use robotnik_msgs_new-msg:BatteryStatus instead.")))

(cl:ensure-generic-function 'voltage-val :lambda-list '(m))
(cl:defmethod voltage-val ((m <BatteryStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:voltage-val is deprecated.  Use robotnik_msgs_new-msg:voltage instead.")
  (voltage m))

(cl:ensure-generic-function 'current-val :lambda-list '(m))
(cl:defmethod current-val ((m <BatteryStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:current-val is deprecated.  Use robotnik_msgs_new-msg:current instead.")
  (current m))

(cl:ensure-generic-function 'level-val :lambda-list '(m))
(cl:defmethod level-val ((m <BatteryStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:level-val is deprecated.  Use robotnik_msgs_new-msg:level instead.")
  (level m))

(cl:ensure-generic-function 'time_remaining-val :lambda-list '(m))
(cl:defmethod time_remaining-val ((m <BatteryStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:time_remaining-val is deprecated.  Use robotnik_msgs_new-msg:time_remaining instead.")
  (time_remaining m))

(cl:ensure-generic-function 'time_charging-val :lambda-list '(m))
(cl:defmethod time_charging-val ((m <BatteryStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:time_charging-val is deprecated.  Use robotnik_msgs_new-msg:time_charging instead.")
  (time_charging m))

(cl:ensure-generic-function 'is_charging-val :lambda-list '(m))
(cl:defmethod is_charging-val ((m <BatteryStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:is_charging-val is deprecated.  Use robotnik_msgs_new-msg:is_charging instead.")
  (is_charging m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<BatteryStatus>)))
  ...
  "robotnik_msgs_new/BatteryStatus")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'BatteryStatus)))
  "Returns string type for a message object of type 'BatteryStatus"
  "robotnik_msgs_new/BatteryStatus")
