...
(cl:defmethod cl:initialize-instance :after ((m <Data>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Data)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotnik_msgs_new-msg:<Data> is deprecated: use robotnik_msgs_new-msg:Data instead.")))

(cl:ensure-generic-function 'interface-val :lambda-list '(m))
(cl:defmethod interface-val ((m <Data>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:interface-val is deprecated.  Use robotnik_msgs_new-msg:interface instead.")
  (interface m))

(cl:ensure-generic-function 'bytes_sent-val :lambda-list '(m))
(cl:defmethod bytes_sent-val ((m <Data>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:bytes_sent-val is deprecated.  Use robotnik_msgs_new-msg:bytes_sent instead.")
  (bytes_sent m))

(cl:ensure-generic-function 'bytes_received-val :lambda-list '(m))
(cl:defmethod bytes_received-val ((m <Data>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:bytes_received-val is deprecated.  Use robotnik_msgs_new-msg:bytes_received instead.")
  (bytes_received m))

(cl:ensure-generic-function 'units_sent-val :lambda-list '(m))
(cl:defmethod units_sent-val ((m <Data>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:units_sent-val is deprecated.  Use robotnik_msgs_new-msg:units_sent instead.")
  (units_sent m))

(cl:ensure-generic-function 'units_received-val :lambda-list '(m))
(cl:defmethod units_received-val ((m <Data>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:units_received-val is deprecated.  Use robotnik_msgs_new-msg:units_received instead.")
  (units_received m))

(cl:ensure-generic-function 'packages_sent-val :lambda-list '(m))
(cl:defmethod packages_sent-val ((m <Data>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:packages_sent-val is deprecated.  Use robotnik_msgs_new-msg:packages_sent instead.")
  (packages_sent m))

(cl:ensure-generic-function 'packages_received-val :lambda-list '(m))
(cl:defmethod packages_received-val ((m <Data>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:packages_received-val is deprecated.  Use robotnik_msgs_new-msg:packages_received instead.")
  (packages_received m))
