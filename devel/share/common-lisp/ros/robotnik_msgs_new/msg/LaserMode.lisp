...
(cl:defmethod cl:initialize-instance :after ((m <LaserMode>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LaserMode)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotnik_msgs_new-msg:<LaserMode> is deprecated: use robotnik_msgs_new-msg:LaserMode instead.")))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<LaserMode>)))
  ...
  (cl:format cl:nil "string STANDARD=standard~%string DOCKING_STATION=docking_station~%string CART=cart~%string CART_DOCKING_CART=cart_docking_cart~%string DOCKING_CART=docking_cart~%string INVALID=invalid~%~%string name~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'LaserMode)))
  "Returns full string definition for message of type 'LaserMode"
  (cl:format cl:nil "string STANDARD=standard~%string DOCKING_STATION=docking_station~%string CART=cart~%string CART_DOCKING_CART=cart_docking_cart~%string DOCKING_CART=docking_cart~%string INVALID=invalid~%~%string name~%~%~%"))
