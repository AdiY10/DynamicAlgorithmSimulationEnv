...
(cl:defclass <RobotnikMotorsStatus> (roslisp-msg-protocol:ros-message)
  ((name
   ...
   (motor_status
    ...
    :type (cl:vector robotnik_msgs_new-msg:MotorStatus)
   :initform (cl:make-array 0 :element-type 'robotnik_msgs_new-msg:MotorStatus :initial-element (cl:make-instance 'robotnik_msgs_new-msg:MotorStatus))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <RobotnikMotorsStatus>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RobotnikMotorsStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotnik_msgs_new-msg:<RobotnikMotorsStatus> is deprecated: use robotnik_msgs_new-msg:RobotnikMotorsStatus instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <RobotnikMotorsStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:name-val is deprecated.  Use robotnik_msgs_new-msg:name instead.")
  (name m))

(cl:ensure-generic-function 'can_id-val :lambda-list '(m))
(cl:defmethod can_id-val ((m <RobotnikMotorsStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:can_id-val is deprecated.  Use robotnik_msgs_new-msg:can_id instead.")
  (can_id m))

(cl:ensure-generic-function 'motor_status-val :lambda-list '(m))
(cl:defmethod motor_status-val ((m <RobotnikMotorsStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:motor_status-val is deprecated.  Use robotnik_msgs_new-msg:motor_status instead.")
  (motor_status m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <RobotnikMotorsStatus>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'motor_status)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:aref vals i) (cl:make-instance 'robotnik_msgs_new-msg:MotorStatus))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<RobotnikMotorsStatus>)))
  ...
  "robotnik_msgs_new/RobotnikMotorsStatus")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'RobotnikMotorsStatus)))
  "Returns string type for a message object of type 'RobotnikMotorsStatus"
  "robotnik_msgs_new/RobotnikMotorsStatus")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<RobotnikMotorsStatus>)))
  ...
  (cl:format cl:nil "# Name of each motor drive~%string[] name~%# CAN ID of each motor drive~%int32[] can_id~%# Status of the motor drive~%robotnik_msgs_new/MotorStatus[] motor_status~%~%~%================================================================================~%MSG: robotnik_msgs_new/MotorStatus~%string state~%string status~%string communicationstatus~%string statusword~%string driveflags~%string[] activestatusword~%string[] activedriveflags~%int32 digitaloutputs~%int32 digitalinputs~%float32 averagecurrent~%float32[] analoginputs~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'RobotnikMotorsStatus)))
  "Returns full string definition for message of type 'RobotnikMotorsStatus"
  (cl:format cl:nil "# Name of each motor drive~%string[] name~%# CAN ID of each motor drive~%int32[] can_id~%# Status of the motor drive~%robotnik_msgs_new/MotorStatus[] motor_status~%~%~%================================================================================~%MSG: robotnik_msgs_new/MotorStatus~%string state~%string status~%string communicationstatus~%string statusword~%string driveflags~%string[] activestatusword~%string[] activedriveflags~%int32 digitaloutputs~%int32 digitalinputs~%float32 averagecurrent~%float32[] analoginputs~%~%~%~%"))
