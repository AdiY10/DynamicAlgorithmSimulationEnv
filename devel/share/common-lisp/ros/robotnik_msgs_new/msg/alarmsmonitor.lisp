...
(cl:defclass <alarmsmonitor> (roslisp-msg-protocol:ros-message)
  ((alarms
    :reader alarms
    :initarg :alarms
    :type (cl:vector robotnik_msgs_new-msg:alarmmonitor)
   :initform (cl:make-array 0 :element-type 'robotnik_msgs_new-msg:alarmmonitor :initial-element (cl:make-instance 'robotnik_msgs_new-msg:alarmmonitor))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <alarmsmonitor>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'alarmsmonitor)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotnik_msgs_new-msg:<alarmsmonitor> is deprecated: use robotnik_msgs_new-msg:alarmsmonitor instead.")))

(cl:ensure-generic-function 'alarms-val :lambda-list '(m))
(cl:defmethod alarms-val ((m <alarmsmonitor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:alarms-val is deprecated.  Use robotnik_msgs_new-msg:alarms instead.")
  (alarms m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <alarmsmonitor>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'alarms)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'robotnik_msgs_new-msg:alarmmonitor))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<alarmsmonitor>)))
  ...
  "robotnik_msgs_new/alarmsmonitor")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'alarmsmonitor)))
  "Returns string type for a message object of type 'alarmsmonitor"
  "robotnik_msgs_new/alarmsmonitor")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<alarmsmonitor>)))
  ...
  (cl:format cl:nil "alarmmonitor[] alarms~%~%================================================================================~%MSG: robotnik_msgs_new/alarmmonitor~%# type: error, warning, event~%string type~%# displaing number for monitoring~%int32 display~%# component~%string component~%# To be shown in HMI~%bool hmi~%# group: alarm group all alarms of same group will be reset at same time~%string group~%# text: more explained information about alarm, should include group, time, conditions, etc~%string text~%# seconds active~%uint64 seconds_active~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'alarmsmonitor)))
  "Returns full string definition for message of type 'alarmsmonitor"
  (cl:format cl:nil "alarmmonitor[] alarms~%~%================================================================================~%MSG: robotnik_msgs_new/alarmmonitor~%# type: error, warning, event~%string type~%# displaing number for monitoring~%int32 display~%# component~%string component~%# To be shown in HMI~%bool hmi~%# group: alarm group all alarms of same group will be reset at same time~%string group~%# text: more explained information about alarm, should include group, time, conditions, etc~%string text~%# seconds active~%uint64 seconds_active~%~%~%"))
