...
(cl:defclass <SetElevatorResult> (roslisp-msg-protocol:ros-message)
  ((result
   ...
   (status
    :reader status
    :initarg :status
    :type robotnik_msgs_new-msg:ElevatorStatus
    :initform (cl:make-instance 'robotnik_msgs_new-msg:ElevatorStatus)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <SetElevatorResult>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetElevatorResult)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotnik_msgs_new-msg:<SetElevatorResult> is deprecated: use robotnik_msgs_new-msg:SetElevatorResult instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetElevatorResult>)))
  ...
  "robotnik_msgs_new/SetElevatorResult")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetElevatorResult)))
  "Returns string type for a message object of type 'SetElevatorResult"
  "robotnik_msgs_new/SetElevatorResult")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SetElevatorResult>)))
  ...
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%bool result~%robotnik_msgs_new/ElevatorStatus status~%~%================================================================================~%MSG: robotnik_msgs_new/ElevatorStatus~%# state~%string RAISING=raising~%string LOWERING=lowering~%string IDLE=idle~%string ERROR_G_IO=error_getting_io~%string ERROR_S_IO=error_setting_io~%string ERROR_TIMEOUT=error_timeout_in_action~%# position~%string UP=up~%string DOWN=down~%string UNKNOWN=unknown~%# IDLE, RAISING, LOWERING~%string state~%# UP, DOWN, UNKNOWN~%string position~%float32 height~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SetElevatorResult)))
  "Returns full string definition for message of type 'SetElevatorResult"
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%bool result~%robotnik_msgs_new/ElevatorStatus status~%~%================================================================================~%MSG: robotnik_msgs_new/ElevatorStatus~%# state~%string RAISING=raising~%string LOWERING=lowering~%string IDLE=idle~%string ERROR_G_IO=error_getting_io~%string ERROR_S_IO=error_setting_io~%string ERROR_TIMEOUT=error_timeout_in_action~%# position~%string UP=up~%string DOWN=down~%string UNKNOWN=unknown~%# IDLE, RAISING, LOWERING~%string state~%# UP, DOWN, UNKNOWN~%string position~%float32 height~%~%~%"))
