...
(cl:defclass <Alarms> (roslisp-msg-protocol:ros-message)
  ((alarms
    :reader alarms
    :initarg :alarms
    :type (cl:vector robotnik_msgs_new-msg:AlarmSensor)
   :initform (cl:make-array 0 :element-type 'robotnik_msgs_new-msg:AlarmSensor :initial-element (cl:make-instance 'robotnik_msgs_new-msg:AlarmSensor))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Alarms>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Alarms)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotnik_msgs_new-msg:<Alarms> is deprecated: use robotnik_msgs_new-msg:Alarms instead.")))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Alarms>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'alarms)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'robotnik_msgs_new-msg:AlarmSensor))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Alarms>)))
  ...
  (cl:format cl:nil "AlarmSensor[] alarms~%~%================================================================================~%MSG: robotnik_msgs_new/AlarmSensor~%int8 id~%string description~%string message~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Alarms)))
  "Returns full string definition for message of type 'Alarms"
  (cl:format cl:nil "AlarmSensor[] alarms~%~%================================================================================~%MSG: robotnik_msgs_new/AlarmSensor~%int8 id~%string description~%string message~%~%~%~%"))
