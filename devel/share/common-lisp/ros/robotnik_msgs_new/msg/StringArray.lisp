...
(cl:defmethod cl:initialize-instance :after ((m <StringArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'StringArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotnik_msgs_new-msg:<StringArray> is deprecated: use robotnik_msgs_new-msg:StringArray instead.")))
