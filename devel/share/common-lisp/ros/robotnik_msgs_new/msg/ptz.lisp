...
(cl:defmethod cl:initialize-instance :after ((m <ptz>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ptz)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotnik_msgs_new-msg:<ptz> is deprecated: use robotnik_msgs_new-msg:ptz instead.")))
...
(cl:defmethod relative-val ((m <ptz>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:relative-val is deprecated.  Use robotnik_msgs_new-msg:relative instead.")
  (relative m))
