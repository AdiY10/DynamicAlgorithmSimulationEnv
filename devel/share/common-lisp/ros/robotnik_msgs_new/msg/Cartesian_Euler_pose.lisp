...
(cl:defmethod cl:initialize-instance :after ((m <Cartesian_Euler_pose>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Cartesian_Euler_pose)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotnik_msgs_new-msg:<Cartesian_Euler_pose> is deprecated: use robotnik_msgs_new-msg:Cartesian_Euler_pose instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <Cartesian_Euler_pose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:x-val is deprecated.  Use robotnik_msgs_new-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <Cartesian_Euler_pose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:y-val is deprecated.  Use robotnik_msgs_new-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <Cartesian_Euler_pose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:z-val is deprecated.  Use robotnik_msgs_new-msg:z instead.")
  (z m))

(cl:ensure-generic-function 'A-val :lambda-list '(m))
(cl:defmethod A-val ((m <Cartesian_Euler_pose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:A-val is deprecated.  Use robotnik_msgs_new-msg:A instead.")
  (A m))

(cl:ensure-generic-function 'B-val :lambda-list '(m))
(cl:defmethod B-val ((m <Cartesian_Euler_pose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:B-val is deprecated.  Use robotnik_msgs_new-msg:B instead.")
  (B m))

(cl:ensure-generic-function 'C-val :lambda-list '(m))
(cl:defmethod C-val ((m <Cartesian_Euler_pose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:C-val is deprecated.  Use robotnik_msgs_new-msg:C instead.")
  (C m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Cartesian_Euler_pose>)))
  ...
  "robotnik_msgs_new/Cartesian_Euler_pose")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Cartesian_Euler_pose)))
  "Returns string type for a message object of type 'Cartesian_Euler_pose"
  "robotnik_msgs_new/Cartesian_Euler_pose")
