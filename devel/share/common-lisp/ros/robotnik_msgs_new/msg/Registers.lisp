...
(cl:defclass <Registers> (roslisp-msg-protocol:ros-message)
  ((registers
    :reader registers
    :initarg :registers
    :type (cl:vector robotnik_msgs_new-msg:Register)
   :initform (cl:make-array 0 :element-type 'robotnik_msgs_new-msg:Register :initial-element (cl:make-instance 'robotnik_msgs_new-msg:Register))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Registers>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Registers)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotnik_msgs_new-msg:<Registers> is deprecated: use robotnik_msgs_new-msg:Registers instead.")))

(cl:ensure-generic-function 'registers-val :lambda-list '(m))
(cl:defmethod registers-val ((m <Registers>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:registers-val is deprecated.  Use robotnik_msgs_new-msg:registers instead.")
  (registers m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Registers>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'registers)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'robotnik_msgs_new-msg:Register))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Registers>)))
  ...
  (cl:format cl:nil "robotnik_msgs_new/Register[] registers~%================================================================================~%MSG: robotnik_msgs_new/Register~%int32 id~%int32 value~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Registers)))
  "Returns full string definition for message of type 'Registers"
  (cl:format cl:nil "robotnik_msgs_new/Register[] registers~%================================================================================~%MSG: robotnik_msgs_new/Register~%int32 id~%int32 value~%~%"))
