...
(cl:defclass <Interfaces> (roslisp-msg-protocol:ros-message)
  ((total
    :reader total
    :initarg :total
    :type robotnik_msgs_new-msg:Data
    :initform (cl:make-instance 'robotnik_msgs_new-msg:Data))
   (interfaces
    :reader interfaces
    :initarg :interfaces
    :type (cl:vector robotnik_msgs_new-msg:Data)
   :initform (cl:make-array 0 :element-type 'robotnik_msgs_new-msg:Data :initial-element (cl:make-instance 'robotnik_msgs_new-msg:Data))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Interfaces>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Interfaces)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotnik_msgs_new-msg:<Interfaces> is deprecated: use robotnik_msgs_new-msg:Interfaces instead.")))

(cl:ensure-generic-function 'total-val :lambda-list '(m))
(cl:defmethod total-val ((m <Interfaces>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:total-val is deprecated.  Use robotnik_msgs_new-msg:total instead.")
  (total m))

(cl:ensure-generic-function 'interfaces-val :lambda-list '(m))
(cl:defmethod interfaces-val ((m <Interfaces>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:interfaces-val is deprecated.  Use robotnik_msgs_new-msg:interfaces instead.")
  (interfaces m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Interfaces>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'interfaces)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'robotnik_msgs_new-msg:Data))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Interfaces>)))
  ...
  (cl:format cl:nil "# Contains the total number of bytes and pkts~%Data total~%# Contains information of every interface~%Data[] interfaces~%~%~%================================================================================~%MSG: robotnik_msgs_new/Data~%string interface~%float32 bytes_sent~%float32 bytes_received~%string units_sent~%string units_received~%int32 packages_sent~%int32 packages_received~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Interfaces)))
  "Returns full string definition for message of type 'Interfaces"
  (cl:format cl:nil "# Contains the total number of bytes and pkts~%Data total~%# Contains information of every interface~%Data[] interfaces~%~%~%================================================================================~%MSG: robotnik_msgs_new/Data~%string interface~%float32 bytes_sent~%float32 bytes_received~%string units_sent~%string units_received~%int32 packages_sent~%int32 packages_received~%~%~%~%"))
