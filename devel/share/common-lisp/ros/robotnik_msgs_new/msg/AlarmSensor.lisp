...
(cl:defmethod cl:initialize-instance :after ((m <AlarmSensor>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AlarmSensor)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotnik_msgs_new-msg:<AlarmSensor> is deprecated: use robotnik_msgs_new-msg:AlarmSensor instead.")))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <AlarmSensor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:id-val is deprecated.  Use robotnik_msgs_new-msg:id instead.")
  (id m))

(cl:ensure-generic-function 'description-val :lambda-list '(m))
(cl:defmethod description-val ((m <AlarmSensor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:description-val is deprecated.  Use robotnik_msgs_new-msg:description instead.")
  (description m))

(cl:ensure-generic-function 'message-val :lambda-list '(m))
(cl:defmethod message-val ((m <AlarmSensor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:message-val is deprecated.  Use robotnik_msgs_new-msg:message instead.")
  (message m))
