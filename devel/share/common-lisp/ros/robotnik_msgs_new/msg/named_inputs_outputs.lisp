...
(cl:defclass <named_inputs_outputs> (roslisp-msg-protocol:ros-message)
  ((digital_inputs
    ...
    :type (cl:vector robotnik_msgs_new-msg:named_input_output)
   :initform (cl:make-array 0 :element-type 'robotnik_msgs_new-msg:named_input_output :initial-element (cl:make-instance 'robotnik_msgs_new-msg:named_input_output)))
   (digital_outputs
...
(cl:defmethod cl:initialize-instance :after ((m <named_inputs_outputs>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'named_inputs_outputs)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotnik_msgs_new-msg:<named_inputs_outputs> is deprecated: use robotnik_msgs_new-msg:named_inputs_outputs instead.")))

(cl:ensure-generic-function 'digital_inputs-val :lambda-list '(m))
(cl:defmethod digital_inputs-val ((m <named_inputs_outputs>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:digital_inputs-val is deprecated.  Use robotnik_msgs_new-msg:digital_inputs instead.")
  (digital_inputs m))

(cl:ensure-generic-function 'digital_outputs-val :lambda-list '(m))
(cl:defmethod digital_outputs-val ((m <named_inputs_outputs>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:digital_outputs-val is deprecated.  Use robotnik_msgs_new-msg:digital_outputs instead.")
  (digital_outputs m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <named_inputs_outputs>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'digital_inputs)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'robotnik_msgs_new-msg:named_input_output))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<named_inputs_outputs>)))
  ...
  "robotnik_msgs_new/named_inputs_outputs")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'named_inputs_outputs)))
  "Returns string type for a message object of type 'named_inputs_outputs"
  "robotnik_msgs_new/named_inputs_outputs")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<named_inputs_outputs>)))
  ...
  (cl:format cl:nil "robotnik_msgs_new/named_input_output[] digital_inputs~%robotnik_msgs_new/named_input_output[] digital_outputs~%================================================================================~%MSG: robotnik_msgs_new/named_input_output~%string name~%bool value~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'named_inputs_outputs)))
  "Returns full string definition for message of type 'named_inputs_outputs"
  (cl:format cl:nil "robotnik_msgs_new/named_input_output[] digital_inputs~%robotnik_msgs_new/named_input_output[] digital_outputs~%================================================================================~%MSG: robotnik_msgs_new/named_input_output~%string name~%bool value~%~%"))
