...
(cl:defmethod cl:initialize-instance :after ((m <BatteryDockingStatus>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BatteryDockingStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotnik_msgs_new-msg:<BatteryDockingStatus> is deprecated: use robotnik_msgs_new-msg:BatteryDockingStatus instead.")))

(cl:ensure-generic-function 'operation_mode-val :lambda-list '(m))
(cl:defmethod operation_mode-val ((m <BatteryDockingStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:operation_mode-val is deprecated.  Use robotnik_msgs_new-msg:operation_mode instead.")
  (operation_mode m))
...
(cl:defmethod contact_relay_status-val ((m <BatteryDockingStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:contact_relay_status-val is deprecated.  Use robotnik_msgs_new-msg:contact_relay_status instead.")
...
(cl:defmethod charger_relay_status-val ((m <BatteryDockingStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:charger_relay_status-val is deprecated.  Use robotnik_msgs_new-msg:charger_relay_status instead.")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<BatteryDockingStatus>)))
  ...
  "robotnik_msgs_new/BatteryDockingStatus")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'BatteryDockingStatus)))
  "Returns string type for a message object of type 'BatteryDockingStatus"
  "robotnik_msgs_new/BatteryDockingStatus")
