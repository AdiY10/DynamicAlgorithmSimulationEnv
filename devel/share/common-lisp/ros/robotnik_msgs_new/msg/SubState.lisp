...
(cl:defmethod cl:initialize-instance :after ((m <SubState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SubState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotnik_msgs_new-msg:<SubState> is deprecated: use robotnik_msgs_new-msg:SubState instead.")))

(cl:ensure-generic-function 'substate-val :lambda-list '(m))
(cl:defmethod substate-val ((m <SubState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:substate-val is deprecated.  Use robotnik_msgs_new-msg:substate instead.")
  (substate m))

(cl:ensure-generic-function 'substate_description-val :lambda-list '(m))
(cl:defmethod substate_description-val ((m <SubState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:substate_description-val is deprecated.  Use robotnik_msgs_new-msg:substate_description instead.")
  (substate_description m))

(cl:ensure-generic-function 'msg-val :lambda-list '(m))
(cl:defmethod msg-val ((m <SubState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:msg-val is deprecated.  Use robotnik_msgs_new-msg:msg instead.")
  (msg m))
