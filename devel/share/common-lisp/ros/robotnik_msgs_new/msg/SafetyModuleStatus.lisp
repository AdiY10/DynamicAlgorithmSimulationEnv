...
(cl:defclass <SafetyModuleStatus> (roslisp-msg-protocol:ros-message)
  ((safety_mode
   ...
   (lasers_mode
    :reader lasers_mode
    :initarg :lasers_mode
    :type robotnik_msgs_new-msg:LaserMode
    :initform (cl:make-instance 'robotnik_msgs_new-msg:LaserMode))
   (lasers_status
    :reader lasers_status
    :initarg :lasers_status
    :type (cl:vector robotnik_msgs_new-msg:LaserStatus)
   :initform (cl:make-array 0 :element-type 'robotnik_msgs_new-msg:LaserStatus :initial-element (cl:make-instance 'robotnik_msgs_new-msg:LaserStatus))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <SafetyModuleStatus>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SafetyModuleStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotnik_msgs_new-msg:<SafetyModuleStatus> is deprecated: use robotnik_msgs_new-msg:SafetyModuleStatus instead.")))

(cl:ensure-generic-function 'safety_mode-val :lambda-list '(m))
(cl:defmethod safety_mode-val ((m <SafetyModuleStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:safety_mode-val is deprecated.  Use robotnik_msgs_new-msg:safety_mode instead.")
  (safety_mode m))

(cl:ensure-generic-function 'charging-val :lambda-list '(m))
(cl:defmethod charging-val ((m <SafetyModuleStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:charging-val is deprecated.  Use robotnik_msgs_new-msg:charging instead.")
  (charging m))

(cl:ensure-generic-function 'emergency_stop-val :lambda-list '(m))
(cl:defmethod emergency_stop-val ((m <SafetyModuleStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:emergency_stop-val is deprecated.  Use robotnik_msgs_new-msg:emergency_stop instead.")
  (emergency_stop m))

(cl:ensure-generic-function 'safety_stop-val :lambda-list '(m))
(cl:defmethod safety_stop-val ((m <SafetyModuleStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:safety_stop-val is deprecated.  Use robotnik_msgs_new-msg:safety_stop instead.")
  (safety_stop m))

(cl:ensure-generic-function 'safety_overrided-val :lambda-list '(m))
(cl:defmethod safety_overrided-val ((m <SafetyModuleStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:safety_overrided-val is deprecated.  Use robotnik_msgs_new-msg:safety_overrided instead.")
  (safety_overrided m))

(cl:ensure-generic-function 'lasers_on_standby-val :lambda-list '(m))
(cl:defmethod lasers_on_standby-val ((m <SafetyModuleStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:lasers_on_standby-val is deprecated.  Use robotnik_msgs_new-msg:lasers_on_standby instead.")
  (lasers_on_standby m))

(cl:ensure-generic-function 'current_speed-val :lambda-list '(m))
(cl:defmethod current_speed-val ((m <SafetyModuleStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:current_speed-val is deprecated.  Use robotnik_msgs_new-msg:current_speed instead.")
  (current_speed m))
...
(cl:defmethod speed_at_safety_stop-val ((m <SafetyModuleStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:speed_at_safety_stop-val is deprecated.  Use robotnik_msgs_new-msg:speed_at_safety_stop instead.")
...
(cl:defmethod lasers_mode-val ((m <SafetyModuleStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:lasers_mode-val is deprecated.  Use robotnik_msgs_new-msg:lasers_mode instead.")
  (lasers_mode m))

(cl:ensure-generic-function 'lasers_status-val :lambda-list '(m))
(cl:defmethod lasers_status-val ((m <SafetyModuleStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-msg:lasers_status-val is deprecated.  Use robotnik_msgs_new-msg:lasers_status instead.")
  (lasers_status m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <SafetyModuleStatus>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'lasers_status)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'robotnik_msgs_new-msg:LaserStatus))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SafetyModuleStatus>)))
  ...
  "robotnik_msgs_new/SafetyModuleStatus")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SafetyModuleStatus)))
  "Returns string type for a message object of type 'SafetyModuleStatus"
  "robotnik_msgs_new/SafetyModuleStatus")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<SafetyModuleStatus>)))
  ...
  "3cc2546ca0e4e9e66c091e756e7d22d7")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'SafetyModuleStatus)))
  "Returns md5sum for a message object of type 'SafetyModuleStatus"
  "3cc2546ca0e4e9e66c091e756e7d22d7")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SafetyModuleStatus>)))
  ...
  (cl:format cl:nil "# robot safety mode~%string SAFE=safe~%string OVERRIDABLE=overridable~%string EMERGENCY=emergency~%string LASER_MUTE=laser_mute~%~%string safety_mode~%bool charging~%bool emergency_stop        # if e-stop is pressed~%bool safety_stop           # if system is stopped due to safety system~%bool safety_overrided      # if safety system is overrided~%bool lasers_on_standby     # if lasers don't have power~%float64 current_speed       # current speed measured by safety system~%float64 speed_at_safety_stop  # speed measured at last safety stop by safety system~%~%robotnik_msgs_new/LaserMode lasers_mode~%robotnik_msgs_new/LaserStatus[] lasers_status~%~%================================================================================~%MSG: robotnik_msgs_new/LaserMode~%string STANDARD=standard~%string DOCKING_STATION=docking_station~%string CART=cart~%string CART_DOCKING_CART=cart_docking_cart~%string DOCKING_CART=docking_cart~%string INVALID=invalid~%~%string name~%~%================================================================================~%MSG: robotnik_msgs_new/LaserStatus~%string name~%bool detecting_obstacles~%bool contaminated~%bool free_warning~%# one input per each warning zone.~%# first areas are closer to the robot (i.e. more restrictive)~%bool[] warning_zones ~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SafetyModuleStatus)))
  "Returns full string definition for message of type 'SafetyModuleStatus"
  (cl:format cl:nil "# robot safety mode~%string SAFE=safe~%string OVERRIDABLE=overridable~%string EMERGENCY=emergency~%string LASER_MUTE=laser_mute~%~%string safety_mode~%bool charging~%bool emergency_stop        # if e-stop is pressed~%bool safety_stop           # if system is stopped due to safety system~%bool safety_overrided      # if safety system is overrided~%bool lasers_on_standby     # if lasers don't have power~%float64 current_speed       # current speed measured by safety system~%float64 speed_at_safety_stop  # speed measured at last safety stop by safety system~%~%robotnik_msgs_new/LaserMode lasers_mode~%robotnik_msgs_new/LaserStatus[] lasers_status~%~%================================================================================~%MSG: robotnik_msgs_new/LaserMode~%string STANDARD=standard~%string DOCKING_STATION=docking_station~%string CART=cart~%string CART_DOCKING_CART=cart_docking_cart~%string DOCKING_CART=docking_cart~%string INVALID=invalid~%~%string name~%~%================================================================================~%MSG: robotnik_msgs_new/LaserStatus~%string name~%bool detecting_obstacles~%bool contaminated~%bool free_warning~%# one input per each warning zone.~%# first areas are closer to the robot (i.e. more restrictive)~%bool[] warning_zones ~%~%~%"))
