...
(cl:defmethod cl:initialize-instance :after ((m <home-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'home-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotnik_msgs_new-srv:<home-request> is deprecated: use robotnik_msgs_new-srv:home-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <home-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'home-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotnik_msgs_new-srv:<home-response> is deprecated: use robotnik_msgs_new-srv:home-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<home-response>)))
  ...
  "robotnik_msgs_new/homeResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'home-response)))
  "Returns string type for a service object of type 'home-response"
  "robotnik_msgs_new/homeResponse")
