...
(cl:defmethod cl:initialize-instance :after ((m <ResetFromSubState-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ResetFromSubState-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotnik_msgs_new-srv:<ResetFromSubState-request> is deprecated: use robotnik_msgs_new-srv:ResetFromSubState-request instead.")))

(cl:ensure-generic-function 'subState-val :lambda-list '(m))
(cl:defmethod subState-val ((m <ResetFromSubState-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-srv:subState-val is deprecated.  Use robotnik_msgs_new-srv:subState instead.")
  (subState m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ResetFromSubState-request>)))
  ...
  "robotnik_msgs_new/ResetFromSubStateRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ResetFromSubState-request)))
  "Returns string type for a service object of type 'ResetFromSubState-request"
  "robotnik_msgs_new/ResetFromSubStateRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <ResetFromSubState-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ResetFromSubState-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotnik_msgs_new-srv:<ResetFromSubState-response> is deprecated: use robotnik_msgs_new-srv:ResetFromSubState-response instead.")))
...
(cl:defmethod currentSubState-val ((m <ResetFromSubState-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-srv:currentSubState-val is deprecated.  Use robotnik_msgs_new-srv:currentSubState instead.")
  (currentSubState m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ResetFromSubState-response>)))
  ...
  "robotnik_msgs_new/ResetFromSubStateResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ResetFromSubState-response)))
  "Returns string type for a service object of type 'ResetFromSubState-response"
  "robotnik_msgs_new/ResetFromSubStateResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ResetFromSubState)))
  ...
  "robotnik_msgs_new/ResetFromSubState")