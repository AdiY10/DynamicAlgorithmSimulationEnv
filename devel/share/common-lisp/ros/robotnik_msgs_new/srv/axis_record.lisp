...
(cl:defmethod cl:initialize-instance :after ((m <axis_record-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'axis_record-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotnik_msgs_new-srv:<axis_record-request> is deprecated: use robotnik_msgs_new-srv:axis_record-request instead.")))

(cl:ensure-generic-function 'action-val :lambda-list '(m))
(cl:defmethod action-val ((m <axis_record-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-srv:action-val is deprecated.  Use robotnik_msgs_new-srv:action instead.")
  (action m))

(cl:ensure-generic-function 'directory-val :lambda-list '(m))
(cl:defmethod directory-val ((m <axis_record-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-srv:directory-val is deprecated.  Use robotnik_msgs_new-srv:directory instead.")
  (directory m))

(cl:ensure-generic-function 'profile-val :lambda-list '(m))
(cl:defmethod profile-val ((m <axis_record-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-srv:profile-val is deprecated.  Use robotnik_msgs_new-srv:profile instead.")
  (profile m))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <axis_record-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-srv:id-val is deprecated.  Use robotnik_msgs_new-srv:id instead.")
  (id m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<axis_record-request>)))
  ...
  "robotnik_msgs_new/axis_recordRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'axis_record-request)))
  "Returns string type for a service object of type 'axis_record-request"
  "robotnik_msgs_new/axis_recordRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <axis_record-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'axis_record-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotnik_msgs_new-srv:<axis_record-response> is deprecated: use robotnik_msgs_new-srv:axis_record-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<axis_record-response>)))
  ...
  "robotnik_msgs_new/axis_recordResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'axis_record-response)))
  "Returns string type for a service object of type 'axis_record-response"
  "robotnik_msgs_new/axis_recordResponse")
