...
(cl:defmethod cl:initialize-instance :after ((m <ack_alarm-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ack_alarm-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotnik_msgs_new-srv:<ack_alarm-request> is deprecated: use robotnik_msgs_new-srv:ack_alarm-request instead.")))

(cl:ensure-generic-function 'type-val :lambda-list '(m))
(cl:defmethod type-val ((m <ack_alarm-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-srv:type-val is deprecated.  Use robotnik_msgs_new-srv:type instead.")
  (type m))

(cl:ensure-generic-function 'group-val :lambda-list '(m))
(cl:defmethod group-val ((m <ack_alarm-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-srv:group-val is deprecated.  Use robotnik_msgs_new-srv:group instead.")
  (group m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ack_alarm-request>)))
  ...
  "robotnik_msgs_new/ack_alarmRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ack_alarm-request)))
  "Returns string type for a service object of type 'ack_alarm-request"
  "robotnik_msgs_new/ack_alarmRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <ack_alarm-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ack_alarm-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotnik_msgs_new-srv:<ack_alarm-response> is deprecated: use robotnik_msgs_new-srv:ack_alarm-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ack_alarm-response>)))
  ...
  "robotnik_msgs_new/ack_alarmResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ack_alarm-response)))
  "Returns string type for a service object of type 'ack_alarm-response"
  "robotnik_msgs_new/ack_alarmResponse")
