...
(cl:defclass <SetElevator-request> (roslisp-msg-protocol:ros-message)
  ((action
    :reader action
    :initarg :action
    :type robotnik_msgs_new-msg:ElevatorAction
    :initform (cl:make-instance 'robotnik_msgs_new-msg:ElevatorAction)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <SetElevator-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetElevator-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotnik_msgs_new-srv:<SetElevator-request> is deprecated: use robotnik_msgs_new-srv:SetElevator-request instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetElevator-request>)))
  ...
  "robotnik_msgs_new/SetElevatorRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetElevator-request)))
  "Returns string type for a service object of type 'SetElevator-request"
  "robotnik_msgs_new/SetElevatorRequest")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SetElevator-request>)))
  ...
  (cl:format cl:nil "robotnik_msgs_new/ElevatorAction action~%~%================================================================================~%MSG: robotnik_msgs_new/ElevatorAction~%int32 RAISE=1~%int32 LOWER=-1~%int32 STOP=0~%int32 NO_ACTION=1000~%~%int32 action~%# speed, height for future applications~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SetElevator-request)))
  "Returns full string definition for message of type 'SetElevator-request"
  (cl:format cl:nil "robotnik_msgs_new/ElevatorAction action~%~%================================================================================~%MSG: robotnik_msgs_new/ElevatorAction~%int32 RAISE=1~%int32 LOWER=-1~%int32 STOP=0~%int32 NO_ACTION=1000~%~%int32 action~%# speed, height for future applications~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <SetElevator-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetElevator-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotnik_msgs_new-srv:<SetElevator-response> is deprecated: use robotnik_msgs_new-srv:SetElevator-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetElevator-response>)))
  ...
  "robotnik_msgs_new/SetElevatorResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetElevator-response)))
  "Returns string type for a service object of type 'SetElevator-response"
  "robotnik_msgs_new/SetElevatorResponse")
