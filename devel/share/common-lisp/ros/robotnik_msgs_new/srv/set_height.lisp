...
(cl:defmethod cl:initialize-instance :after ((m <set_height-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'set_height-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotnik_msgs_new-srv:<set_height-request> is deprecated: use robotnik_msgs_new-srv:set_height-request instead.")))

(cl:ensure-generic-function 'height-val :lambda-list '(m))
(cl:defmethod height-val ((m <set_height-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-srv:height-val is deprecated.  Use robotnik_msgs_new-srv:height instead.")
  (height m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<set_height-request>)))
  ...
  "robotnik_msgs_new/set_heightRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'set_height-request)))
  "Returns string type for a service object of type 'set_height-request"
  "robotnik_msgs_new/set_heightRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <set_height-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'set_height-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotnik_msgs_new-srv:<set_height-response> is deprecated: use robotnik_msgs_new-srv:set_height-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<set_height-response>)))
  ...
  "robotnik_msgs_new/set_heightResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'set_height-response)))
  "Returns string type for a service object of type 'set_height-response"
  "robotnik_msgs_new/set_heightResponse")
