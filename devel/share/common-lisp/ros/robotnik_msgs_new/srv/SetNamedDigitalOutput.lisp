...
(cl:defmethod cl:initialize-instance :after ((m <SetNamedDigitalOutput-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetNamedDigitalOutput-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotnik_msgs_new-srv:<SetNamedDigitalOutput-request> is deprecated: use robotnik_msgs_new-srv:SetNamedDigitalOutput-request instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <SetNamedDigitalOutput-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-srv:name-val is deprecated.  Use robotnik_msgs_new-srv:name instead.")
  (name m))

(cl:ensure-generic-function 'value-val :lambda-list '(m))
(cl:defmethod value-val ((m <SetNamedDigitalOutput-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-srv:value-val is deprecated.  Use robotnik_msgs_new-srv:value instead.")
  (value m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetNamedDigitalOutput-request>)))
  ...
  "robotnik_msgs_new/SetNamedDigitalOutputRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetNamedDigitalOutput-request)))
  "Returns string type for a service object of type 'SetNamedDigitalOutput-request"
  "robotnik_msgs_new/SetNamedDigitalOutputRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SetNamedDigitalOutput-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetNamedDigitalOutput-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotnik_msgs_new-srv:<SetNamedDigitalOutput-response> is deprecated: use robotnik_msgs_new-srv:SetNamedDigitalOutput-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetNamedDigitalOutput-response>)))
  ...
  "robotnik_msgs_new/SetNamedDigitalOutputResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetNamedDigitalOutput-response)))
  "Returns string type for a service object of type 'SetNamedDigitalOutput-response"
  "robotnik_msgs_new/SetNamedDigitalOutputResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetNamedDigitalOutput)))
  ...
  "robotnik_msgs_new/SetNamedDigitalOutput")