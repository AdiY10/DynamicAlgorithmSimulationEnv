...
(cl:defmethod cl:initialize-instance :after ((m <InsertTask-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'InsertTask-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotnik_msgs_new-srv:<InsertTask-request> is deprecated: use robotnik_msgs_new-srv:InsertTask-request instead.")))

(cl:ensure-generic-function 'id_submission-val :lambda-list '(m))
(cl:defmethod id_submission-val ((m <InsertTask-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-srv:id_submission-val is deprecated.  Use robotnik_msgs_new-srv:id_submission instead.")
  (id_submission m))

(cl:ensure-generic-function 'description_task-val :lambda-list '(m))
(cl:defmethod description_task-val ((m <InsertTask-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-srv:description_task-val is deprecated.  Use robotnik_msgs_new-srv:description_task instead.")
  (description_task m))

(cl:ensure-generic-function 'datatime_start-val :lambda-list '(m))
(cl:defmethod datatime_start-val ((m <InsertTask-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-srv:datatime_start-val is deprecated.  Use robotnik_msgs_new-srv:datatime_start instead.")
  (datatime_start m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<InsertTask-request>)))
  ...
  "robotnik_msgs_new/InsertTaskRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'InsertTask-request)))
  "Returns string type for a service object of type 'InsertTask-request"
  "robotnik_msgs_new/InsertTaskRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <InsertTask-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'InsertTask-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotnik_msgs_new-srv:<InsertTask-response> is deprecated: use robotnik_msgs_new-srv:InsertTask-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<InsertTask-response>)))
  ...
  "robotnik_msgs_new/InsertTaskResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'InsertTask-response)))
  "Returns string type for a service object of type 'InsertTask-response"
  "robotnik_msgs_new/InsertTaskResponse")
