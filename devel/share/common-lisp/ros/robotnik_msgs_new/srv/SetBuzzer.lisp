...
(cl:defmethod cl:initialize-instance :after ((m <SetBuzzer-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetBuzzer-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotnik_msgs_new-srv:<SetBuzzer-request> is deprecated: use robotnik_msgs_new-srv:SetBuzzer-request instead.")))

(cl:ensure-generic-function 'enable-val :lambda-list '(m))
(cl:defmethod enable-val ((m <SetBuzzer-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-srv:enable-val is deprecated.  Use robotnik_msgs_new-srv:enable instead.")
  (enable m))

(cl:ensure-generic-function 'beep_freq-val :lambda-list '(m))
(cl:defmethod beep_freq-val ((m <SetBuzzer-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-srv:beep_freq-val is deprecated.  Use robotnik_msgs_new-srv:beep_freq instead.")
  (beep_freq m))

(cl:ensure-generic-function 'time_enabled-val :lambda-list '(m))
(cl:defmethod time_enabled-val ((m <SetBuzzer-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-srv:time_enabled-val is deprecated.  Use robotnik_msgs_new-srv:time_enabled instead.")
  (time_enabled m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetBuzzer-request>)))
  ...
  "robotnik_msgs_new/SetBuzzerRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetBuzzer-request)))
  "Returns string type for a service object of type 'SetBuzzer-request"
  "robotnik_msgs_new/SetBuzzerRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SetBuzzer-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetBuzzer-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotnik_msgs_new-srv:<SetBuzzer-response> is deprecated: use robotnik_msgs_new-srv:SetBuzzer-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetBuzzer-response>)))
  ...
  "robotnik_msgs_new/SetBuzzerResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetBuzzer-response)))
  "Returns string type for a service object of type 'SetBuzzer-response"
  "robotnik_msgs_new/SetBuzzerResponse")
