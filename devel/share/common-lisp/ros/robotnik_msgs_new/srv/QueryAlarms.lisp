...
(cl:defmethod cl:initialize-instance :after ((m <QueryAlarms-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'QueryAlarms-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotnik_msgs_new-srv:<QueryAlarms-request> is deprecated: use robotnik_msgs_new-srv:QueryAlarms-request instead.")))

(cl:ensure-generic-function 'type_query-val :lambda-list '(m))
(cl:defmethod type_query-val ((m <QueryAlarms-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-srv:type_query-val is deprecated.  Use robotnik_msgs_new-srv:type_query instead.")
  (type_query m))

(cl:ensure-generic-function 'start_date-val :lambda-list '(m))
(cl:defmethod start_date-val ((m <QueryAlarms-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-srv:start_date-val is deprecated.  Use robotnik_msgs_new-srv:start_date instead.")
  (start_date m))

(cl:ensure-generic-function 'end_date-val :lambda-list '(m))
(cl:defmethod end_date-val ((m <QueryAlarms-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-srv:end_date-val is deprecated.  Use robotnik_msgs_new-srv:end_date instead.")
  (end_date m))

(cl:ensure-generic-function 'top-val :lambda-list '(m))
(cl:defmethod top-val ((m <QueryAlarms-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-srv:top-val is deprecated.  Use robotnik_msgs_new-srv:top instead.")
  (top m))

(cl:ensure-generic-function 'filter_type-val :lambda-list '(m))
(cl:defmethod filter_type-val ((m <QueryAlarms-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-srv:filter_type-val is deprecated.  Use robotnik_msgs_new-srv:filter_type instead.")
  (filter_type m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<QueryAlarms-request>)))
  ...
  "robotnik_msgs_new/QueryAlarmsRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'QueryAlarms-request)))
  "Returns string type for a service object of type 'QueryAlarms-request"
  "robotnik_msgs_new/QueryAlarmsRequest")
...
(cl:defclass <QueryAlarms-response> (roslisp-msg-protocol:ros-message)
  ((alarms
    :reader alarms
    :initarg :alarms
    :type (cl:vector robotnik_msgs_new-msg:QueryAlarm)
   :initform (cl:make-array 0 :element-type 'robotnik_msgs_new-msg:QueryAlarm :initial-element (cl:make-instance 'robotnik_msgs_new-msg:QueryAlarm)))
   (success
    :reader success
    :initarg :success
    :type cl:boolean
...
(cl:defmethod cl:initialize-instance :after ((m <QueryAlarms-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'QueryAlarms-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotnik_msgs_new-srv:<QueryAlarms-response> is deprecated: use robotnik_msgs_new-srv:QueryAlarms-response instead.")))

(cl:ensure-generic-function 'alarms-val :lambda-list '(m))
(cl:defmethod alarms-val ((m <QueryAlarms-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-srv:alarms-val is deprecated.  Use robotnik_msgs_new-srv:alarms instead.")
  (alarms m))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <QueryAlarms-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-srv:success-val is deprecated.  Use robotnik_msgs_new-srv:success instead.")
  (success m))

(cl:ensure-generic-function 'msg-val :lambda-list '(m))
(cl:defmethod msg-val ((m <QueryAlarms-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-srv:msg-val is deprecated.  Use robotnik_msgs_new-srv:msg instead.")
  (msg m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <QueryAlarms-response>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'alarms)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'robotnik_msgs_new-msg:QueryAlarm))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<QueryAlarms-response>)))
  ...
  "robotnik_msgs_new/QueryAlarmsResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'QueryAlarms-response)))
  "Returns string type for a service object of type 'QueryAlarms-response"
  "robotnik_msgs_new/QueryAlarmsResponse")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<QueryAlarms-response>)))
  ...
  (cl:format cl:nil "QueryAlarm[] alarms~%bool success~%string msg~%~%~%================================================================================~%MSG: robotnik_msgs_new/QueryAlarm~%int32 alm_id~%string alm_component~%string alm_type~%string alm_group~%string alm_description~%string alm_start_time~%string alm_end_time~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'QueryAlarms-response)))
  "Returns full string definition for message of type 'QueryAlarms-response"
  (cl:format cl:nil "QueryAlarm[] alarms~%bool success~%string msg~%~%~%================================================================================~%MSG: robotnik_msgs_new/QueryAlarm~%int32 alm_id~%string alm_component~%string alm_type~%string alm_group~%string alm_description~%string alm_start_time~%string alm_end_time~%~%~%"))
