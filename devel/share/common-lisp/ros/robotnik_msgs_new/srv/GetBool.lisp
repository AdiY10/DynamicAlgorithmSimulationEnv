...
(cl:defmethod cl:initialize-instance :after ((m <GetBool-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetBool-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotnik_msgs_new-srv:<GetBool-request> is deprecated: use robotnik_msgs_new-srv:GetBool-request instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetBool-request>)))
  ...
  "robotnik_msgs_new/GetBoolRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetBool-request)))
  "Returns string type for a service object of type 'GetBool-request"
  "robotnik_msgs_new/GetBoolRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <GetBool-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetBool-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotnik_msgs_new-srv:<GetBool-response> is deprecated: use robotnik_msgs_new-srv:GetBool-response instead.")))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <GetBool-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-srv:data-val is deprecated.  Use robotnik_msgs_new-srv:data instead.")
  (data m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetBool-response>)))
  ...
  "robotnik_msgs_new/GetBoolResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetBool-response)))
  "Returns string type for a service object of type 'GetBool-response"
  "robotnik_msgs_new/GetBoolResponse")
