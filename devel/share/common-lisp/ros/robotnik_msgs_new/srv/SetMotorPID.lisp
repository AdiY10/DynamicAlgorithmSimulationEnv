...
(cl:defclass <SetMotorPID-request> (roslisp-msg-protocol:ros-message)
  ((pid
    :reader pid
    :initarg :pid
    :type robotnik_msgs_new-msg:MotorPID
    :initform (cl:make-instance 'robotnik_msgs_new-msg:MotorPID)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <SetMotorPID-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetMotorPID-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotnik_msgs_new-srv:<SetMotorPID-request> is deprecated: use robotnik_msgs_new-srv:SetMotorPID-request instead.")))

(cl:ensure-generic-function 'pid-val :lambda-list '(m))
(cl:defmethod pid-val ((m <SetMotorPID-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-srv:pid-val is deprecated.  Use robotnik_msgs_new-srv:pid instead.")
  (pid m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetMotorPID-request>)))
  ...
  "robotnik_msgs_new/SetMotorPIDRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetMotorPID-request)))
  "Returns string type for a service object of type 'SetMotorPID-request"
  "robotnik_msgs_new/SetMotorPIDRequest")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SetMotorPID-request>)))
  ...
  (cl:format cl:nil "MotorPID pid~%~%================================================================================~%MSG: robotnik_msgs_new/MotorPID~%# either can_id or name are set~%# if can_id is -1, then this refers to all motors.~%int32[] can_id~%string[] name~%float32[] kp~%float32[] ki~%float32[] kd~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SetMotorPID-request)))
  "Returns full string definition for message of type 'SetMotorPID-request"
  (cl:format cl:nil "MotorPID pid~%~%================================================================================~%MSG: robotnik_msgs_new/MotorPID~%# either can_id or name are set~%# if can_id is -1, then this refers to all motors.~%int32[] can_id~%string[] name~%float32[] kp~%float32[] ki~%float32[] kd~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <SetMotorPID-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetMotorPID-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotnik_msgs_new-srv:<SetMotorPID-response> is deprecated: use robotnik_msgs_new-srv:SetMotorPID-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetMotorPID-response>)))
  ...
  "robotnik_msgs_new/SetMotorPIDResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetMotorPID-response)))
  "Returns string type for a service object of type 'SetMotorPID-response"
  "robotnik_msgs_new/SetMotorPIDResponse")
