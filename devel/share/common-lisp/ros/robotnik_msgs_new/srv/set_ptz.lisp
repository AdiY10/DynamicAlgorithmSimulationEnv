...
(cl:defmethod cl:initialize-instance :after ((m <set_ptz-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'set_ptz-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotnik_msgs_new-srv:<set_ptz-request> is deprecated: use robotnik_msgs_new-srv:set_ptz-request instead.")))

(cl:ensure-generic-function 'pan-val :lambda-list '(m))
(cl:defmethod pan-val ((m <set_ptz-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-srv:pan-val is deprecated.  Use robotnik_msgs_new-srv:pan instead.")
  (pan m))

(cl:ensure-generic-function 'tilt-val :lambda-list '(m))
(cl:defmethod tilt-val ((m <set_ptz-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-srv:tilt-val is deprecated.  Use robotnik_msgs_new-srv:tilt instead.")
  (tilt m))

(cl:ensure-generic-function 'zoom-val :lambda-list '(m))
(cl:defmethod zoom-val ((m <set_ptz-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-srv:zoom-val is deprecated.  Use robotnik_msgs_new-srv:zoom instead.")
  (zoom m))

(cl:ensure-generic-function 'relative-val :lambda-list '(m))
(cl:defmethod relative-val ((m <set_ptz-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-srv:relative-val is deprecated.  Use robotnik_msgs_new-srv:relative instead.")
  (relative m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<set_ptz-request>)))
  ...
  "robotnik_msgs_new/set_ptzRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'set_ptz-request)))
  "Returns string type for a service object of type 'set_ptz-request"
  "robotnik_msgs_new/set_ptzRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <set_ptz-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'set_ptz-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotnik_msgs_new-srv:<set_ptz-response> is deprecated: use robotnik_msgs_new-srv:set_ptz-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<set_ptz-response>)))
  ...
  "robotnik_msgs_new/set_ptzResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'set_ptz-response)))
  "Returns string type for a service object of type 'set_ptz-response"
  "robotnik_msgs_new/set_ptzResponse")
