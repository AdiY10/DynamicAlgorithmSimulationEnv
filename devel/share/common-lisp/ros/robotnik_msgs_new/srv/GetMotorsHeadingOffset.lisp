...
(cl:defmethod cl:initialize-instance :after ((m <GetMotorsHeadingOffset-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetMotorsHeadingOffset-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotnik_msgs_new-srv:<GetMotorsHeadingOffset-request> is deprecated: use robotnik_msgs_new-srv:GetMotorsHeadingOffset-request instead.")))

(cl:ensure-generic-function 'request-val :lambda-list '(m))
(cl:defmethod request-val ((m <GetMotorsHeadingOffset-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-srv:request-val is deprecated.  Use robotnik_msgs_new-srv:request instead.")
  (request m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetMotorsHeadingOffset-request>)))
  ...
  "robotnik_msgs_new/GetMotorsHeadingOffsetRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetMotorsHeadingOffset-request)))
  "Returns string type for a service object of type 'GetMotorsHeadingOffset-request"
  "robotnik_msgs_new/GetMotorsHeadingOffsetRequest")
...
(cl:defclass <GetMotorsHeadingOffset-response> (roslisp-msg-protocol:ros-message)
  ((offsets
    :reader offsets
    :initarg :offsets
    :type (cl:vector robotnik_msgs_new-msg:MotorHeadingOffset)
   :initform (cl:make-array 0 :element-type 'robotnik_msgs_new-msg:MotorHeadingOffset :initial-element (cl:make-instance 'robotnik_msgs_new-msg:MotorHeadingOffset))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <GetMotorsHeadingOffset-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetMotorsHeadingOffset-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotnik_msgs_new-srv:<GetMotorsHeadingOffset-response> is deprecated: use robotnik_msgs_new-srv:GetMotorsHeadingOffset-response instead.")))

(cl:ensure-generic-function 'offsets-val :lambda-list '(m))
(cl:defmethod offsets-val ((m <GetMotorsHeadingOffset-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-srv:offsets-val is deprecated.  Use robotnik_msgs_new-srv:offsets instead.")
  (offsets m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <GetMotorsHeadingOffset-response>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'offsets)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'robotnik_msgs_new-msg:MotorHeadingOffset))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetMotorsHeadingOffset-response>)))
  ...
  "robotnik_msgs_new/GetMotorsHeadingOffsetResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetMotorsHeadingOffset-response)))
  "Returns string type for a service object of type 'GetMotorsHeadingOffset-response"
  "robotnik_msgs_new/GetMotorsHeadingOffsetResponse")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<GetMotorsHeadingOffset-response>)))
  ...
  (cl:format cl:nil "robotnik_msgs_new/MotorHeadingOffset[] offsets~%~%~%================================================================================~%MSG: robotnik_msgs_new/MotorHeadingOffset~%int32 motor~%float64 value~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'GetMotorsHeadingOffset-response)))
  "Returns full string definition for message of type 'GetMotorsHeadingOffset-response"
  (cl:format cl:nil "robotnik_msgs_new/MotorHeadingOffset[] offsets~%~%~%================================================================================~%MSG: robotnik_msgs_new/MotorHeadingOffset~%int32 motor~%float64 value~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetMotorsHeadingOffset)))
  ...
  "robotnik_msgs_new/GetMotorsHeadingOffset")