...
(cl:defclass <SetEncoderTurns-request> (roslisp-msg-protocol:ros-message)
  ((encoder_turns
    ...
    :type robotnik_msgs_new-msg:MotorHeadingOffset
    :initform (cl:make-instance 'robotnik_msgs_new-msg:MotorHeadingOffset)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <SetEncoderTurns-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetEncoderTurns-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotnik_msgs_new-srv:<SetEncoderTurns-request> is deprecated: use robotnik_msgs_new-srv:SetEncoderTurns-request instead.")))

(cl:ensure-generic-function 'encoder_turns-val :lambda-list '(m))
(cl:defmethod encoder_turns-val ((m <SetEncoderTurns-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-srv:encoder_turns-val is deprecated.  Use robotnik_msgs_new-srv:encoder_turns instead.")
  (encoder_turns m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetEncoderTurns-request>)))
  ...
  "robotnik_msgs_new/SetEncoderTurnsRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetEncoderTurns-request)))
  "Returns string type for a service object of type 'SetEncoderTurns-request"
  "robotnik_msgs_new/SetEncoderTurnsRequest")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SetEncoderTurns-request>)))
  ...
  (cl:format cl:nil "robotnik_msgs_new/MotorHeadingOffset encoder_turns~%~%================================================================================~%MSG: robotnik_msgs_new/MotorHeadingOffset~%int32 motor~%float64 value~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SetEncoderTurns-request)))
  "Returns full string definition for message of type 'SetEncoderTurns-request"
  (cl:format cl:nil "robotnik_msgs_new/MotorHeadingOffset encoder_turns~%~%================================================================================~%MSG: robotnik_msgs_new/MotorHeadingOffset~%int32 motor~%float64 value~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <SetEncoderTurns-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetEncoderTurns-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotnik_msgs_new-srv:<SetEncoderTurns-response> is deprecated: use robotnik_msgs_new-srv:SetEncoderTurns-response instead.")))
...
(cl:defmethod message-val ((m <SetEncoderTurns-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotnik_msgs_new-srv:message-val is deprecated.  Use robotnik_msgs_new-srv:message instead.")
  (message m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetEncoderTurns-response>)))
  ...
  "robotnik_msgs_new/SetEncoderTurnsResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetEncoderTurns-response)))
  "Returns string type for a service object of type 'SetEncoderTurns-response"
  "robotnik_msgs_new/SetEncoderTurnsResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetEncoderTurns)))
  ...
  "robotnik_msgs_new/SetEncoderTurns")