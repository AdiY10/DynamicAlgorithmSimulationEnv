...
(cl:defmethod cl:initialize-instance :after ((m <SetPayload-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetPayload-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ur_msgs_new-srv:<SetPayload-request> is deprecated: use ur_msgs_new-srv:SetPayload-request instead.")))

(cl:ensure-generic-function 'payload-val :lambda-list '(m))
(cl:defmethod payload-val ((m <SetPayload-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ur_msgs_new-srv:payload-val is deprecated.  Use ur_msgs_new-srv:payload instead.")
  (payload m))
...
(cl:defmethod cl:initialize-instance :after ((m <SetPayload-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetPayload-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ur_msgs_new-srv:<SetPayload-response> is deprecated: use ur_msgs_new-srv:SetPayload-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetPayload-response>)))
  ...
  "ur_msgs_new/SetPayloadResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetPayload-response)))
  "Returns string type for a service object of type 'SetPayload-response"
  "ur_msgs_new/SetPayloadResponse")
