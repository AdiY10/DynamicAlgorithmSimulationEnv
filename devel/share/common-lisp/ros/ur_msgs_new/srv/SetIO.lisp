...
(cl:defmethod cl:initialize-instance :after ((m <SetIO-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetIO-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ur_msgs_new-srv:<SetIO-request> is deprecated: use ur_msgs_new-srv:SetIO-request instead.")))

(cl:ensure-generic-function 'fun-val :lambda-list '(m))
(cl:defmethod fun-val ((m <SetIO-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ur_msgs_new-srv:fun-val is deprecated.  Use ur_msgs_new-srv:fun instead.")
  (fun m))

(cl:ensure-generic-function 'pin-val :lambda-list '(m))
(cl:defmethod pin-val ((m <SetIO-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ur_msgs_new-srv:pin-val is deprecated.  Use ur_msgs_new-srv:pin instead.")
  (pin m))

(cl:ensure-generic-function 'state-val :lambda-list '(m))
(cl:defmethod state-val ((m <SetIO-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ur_msgs_new-srv:state-val is deprecated.  Use ur_msgs_new-srv:state instead.")
  (state m))
...
(cl:defmethod cl:initialize-instance :after ((m <SetIO-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetIO-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ur_msgs_new-srv:<SetIO-response> is deprecated: use ur_msgs_new-srv:SetIO-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <SetIO-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ur_msgs_new-srv:success-val is deprecated.  Use ur_msgs_new-srv:success instead.")
  (success m))
