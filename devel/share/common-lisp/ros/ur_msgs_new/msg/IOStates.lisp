...
(cl:defclass <IOStates> (roslisp-msg-protocol:ros-message)
  ((digital_in_states
    ...
    :type (cl:vector ur_msgs_new-msg:Digital)
   :initform (cl:make-array 0 :element-type 'ur_msgs_new-msg:Digital :initial-element (cl:make-instance 'ur_msgs_new-msg:Digital)))
   (digital_out_states
   ...
   (analog_in_states
    ...
    :type (cl:vector ur_msgs_new-msg:Analog)
   :initform (cl:make-array 0 :element-type 'ur_msgs_new-msg:Analog :initial-element (cl:make-instance 'ur_msgs_new-msg:Analog)))
   (analog_out_states
...
(cl:defmethod cl:initialize-instance :after ((m <IOStates>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'IOStates)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ur_msgs_new-msg:<IOStates> is deprecated: use ur_msgs_new-msg:IOStates instead.")))

(cl:ensure-generic-function 'digital_in_states-val :lambda-list '(m))
(cl:defmethod digital_in_states-val ((m <IOStates>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ur_msgs_new-msg:digital_in_states-val is deprecated.  Use ur_msgs_new-msg:digital_in_states instead.")
  (digital_in_states m))

(cl:ensure-generic-function 'digital_out_states-val :lambda-list '(m))
(cl:defmethod digital_out_states-val ((m <IOStates>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ur_msgs_new-msg:digital_out_states-val is deprecated.  Use ur_msgs_new-msg:digital_out_states instead.")
  (digital_out_states m))

(cl:ensure-generic-function 'flag_states-val :lambda-list '(m))
(cl:defmethod flag_states-val ((m <IOStates>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ur_msgs_new-msg:flag_states-val is deprecated.  Use ur_msgs_new-msg:flag_states instead.")
  (flag_states m))

(cl:ensure-generic-function 'analog_in_states-val :lambda-list '(m))
(cl:defmethod analog_in_states-val ((m <IOStates>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ur_msgs_new-msg:analog_in_states-val is deprecated.  Use ur_msgs_new-msg:analog_in_states instead.")
  (analog_in_states m))

(cl:ensure-generic-function 'analog_out_states-val :lambda-list '(m))
(cl:defmethod analog_out_states-val ((m <IOStates>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ur_msgs_new-msg:analog_out_states-val is deprecated.  Use ur_msgs_new-msg:analog_out_states instead.")
  (analog_out_states m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <IOStates>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'digital_in_states)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'ur_msgs_new-msg:Digital))
  ...
  (cl:let ((vals (cl:slot-value msg 'analog_in_states)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:aref vals i) (cl:make-instance 'ur_msgs_new-msg:Analog))
  (roslisp-msg-protocol:deserialize (cl:aref vals i) istream))))
  (cl:let ((__ros_arr_len 0))
    (cl:setf (cl:ldb (cl:byte 8 0) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 8) __ros_arr_len) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<IOStates>)))
  ...
  (cl:format cl:nil "Digital[] digital_in_states~%Digital[] digital_out_states~%Digital[] flag_states~%Analog[] analog_in_states~%Analog[] analog_out_states~%~%================================================================================~%MSG: ur_msgs_new/Digital~%uint8 pin~%bool state~%~%================================================================================~%MSG: ur_msgs_new/Analog~%uint8 VOLTAGE=0~%uint8 CURRENT=1~%~%uint8 pin~%uint8 domain # can be VOLTAGE or CURRENT~%float32 state~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'IOStates)))
  "Returns full string definition for message of type 'IOStates"
  (cl:format cl:nil "Digital[] digital_in_states~%Digital[] digital_out_states~%Digital[] flag_states~%Analog[] analog_in_states~%Analog[] analog_out_states~%~%================================================================================~%MSG: ur_msgs_new/Digital~%uint8 pin~%bool state~%~%================================================================================~%MSG: ur_msgs_new/Analog~%uint8 VOLTAGE=0~%uint8 CURRENT=1~%~%uint8 pin~%uint8 domain # can be VOLTAGE or CURRENT~%float32 state~%~%~%"))
