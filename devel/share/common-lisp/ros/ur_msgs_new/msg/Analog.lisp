...
(cl:defmethod cl:initialize-instance :after ((m <Analog>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Analog)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ur_msgs_new-msg:<Analog> is deprecated: use ur_msgs_new-msg:Analog instead.")))

(cl:ensure-generic-function 'pin-val :lambda-list '(m))
(cl:defmethod pin-val ((m <Analog>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ur_msgs_new-msg:pin-val is deprecated.  Use ur_msgs_new-msg:pin instead.")
  (pin m))

(cl:ensure-generic-function 'domain-val :lambda-list '(m))
(cl:defmethod domain-val ((m <Analog>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ur_msgs_new-msg:domain-val is deprecated.  Use ur_msgs_new-msg:domain instead.")
  (domain m))

(cl:ensure-generic-function 'state-val :lambda-list '(m))
(cl:defmethod state-val ((m <Analog>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ur_msgs_new-msg:state-val is deprecated.  Use ur_msgs_new-msg:state instead.")
  (state m))
