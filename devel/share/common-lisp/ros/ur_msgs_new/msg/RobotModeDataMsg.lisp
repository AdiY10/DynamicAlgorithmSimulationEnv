...
(cl:defmethod cl:initialize-instance :after ((m <RobotModeDataMsg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RobotModeDataMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ur_msgs_new-msg:<RobotModeDataMsg> is deprecated: use ur_msgs_new-msg:RobotModeDataMsg instead.")))

(cl:ensure-generic-function 'timestamp-val :lambda-list '(m))
(cl:defmethod timestamp-val ((m <RobotModeDataMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ur_msgs_new-msg:timestamp-val is deprecated.  Use ur_msgs_new-msg:timestamp instead.")
  (timestamp m))

(cl:ensure-generic-function 'is_robot_connected-val :lambda-list '(m))
(cl:defmethod is_robot_connected-val ((m <RobotModeDataMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ur_msgs_new-msg:is_robot_connected-val is deprecated.  Use ur_msgs_new-msg:is_robot_connected instead.")
...
(cl:defmethod is_real_robot_enabled-val ((m <RobotModeDataMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ur_msgs_new-msg:is_real_robot_enabled-val is deprecated.  Use ur_msgs_new-msg:is_real_robot_enabled instead.")
...
(cl:defmethod is_power_on_robot-val ((m <RobotModeDataMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ur_msgs_new-msg:is_power_on_robot-val is deprecated.  Use ur_msgs_new-msg:is_power_on_robot instead.")
  (is_power_on_robot m))
...
(cl:defmethod is_emergency_stopped-val ((m <RobotModeDataMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ur_msgs_new-msg:is_emergency_stopped-val is deprecated.  Use ur_msgs_new-msg:is_emergency_stopped instead.")
...
(cl:defmethod is_protective_stopped-val ((m <RobotModeDataMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ur_msgs_new-msg:is_protective_stopped-val is deprecated.  Use ur_msgs_new-msg:is_protective_stopped instead.")
...
(cl:defmethod is_program_running-val ((m <RobotModeDataMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ur_msgs_new-msg:is_program_running-val is deprecated.  Use ur_msgs_new-msg:is_program_running instead.")
...
(cl:defmethod is_program_paused-val ((m <RobotModeDataMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ur_msgs_new-msg:is_program_paused-val is deprecated.  Use ur_msgs_new-msg:is_program_paused instead.")
  (is_program_paused m))
