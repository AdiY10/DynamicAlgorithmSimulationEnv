...
(cl:defmethod cl:initialize-instance :after ((m <GetPhysicsProperties-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetPhysicsProperties-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gazebo_msgs_new-srv:<GetPhysicsProperties-request> is deprecated: use gazebo_msgs_new-srv:GetPhysicsProperties-request instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetPhysicsProperties-request>)))
  ...
  "gazebo_msgs_new/GetPhysicsPropertiesRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetPhysicsProperties-request)))
  "Returns string type for a service object of type 'GetPhysicsProperties-request"
  "gazebo_msgs_new/GetPhysicsPropertiesRequest")
...
(cl:defclass <GetPhysicsProperties-response> (roslisp-msg-protocol:ros-message)
  ((time_step
   ...
   (ode_config
    :reader ode_config
    :initarg :ode_config
    :type gazebo_msgs_new-msg:ODEPhysics
    :initform (cl:make-instance 'gazebo_msgs_new-msg:ODEPhysics))
   (success
    :reader success
    :initarg :success
    :type cl:boolean
...
(cl:defmethod cl:initialize-instance :after ((m <GetPhysicsProperties-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetPhysicsProperties-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gazebo_msgs_new-srv:<GetPhysicsProperties-response> is deprecated: use gazebo_msgs_new-srv:GetPhysicsProperties-response instead.")))

(cl:ensure-generic-function 'time_step-val :lambda-list '(m))
(cl:defmethod time_step-val ((m <GetPhysicsProperties-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gazebo_msgs_new-srv:time_step-val is deprecated.  Use gazebo_msgs_new-srv:time_step instead.")
  (time_step m))

(cl:ensure-generic-function 'pause-val :lambda-list '(m))
(cl:defmethod pause-val ((m <GetPhysicsProperties-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gazebo_msgs_new-srv:pause-val is deprecated.  Use gazebo_msgs_new-srv:pause instead.")
  (pause m))
...
(cl:defmethod max_update_rate-val ((m <GetPhysicsProperties-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gazebo_msgs_new-srv:max_update_rate-val is deprecated.  Use gazebo_msgs_new-srv:max_update_rate instead.")
  (max_update_rate m))

(cl:ensure-generic-function 'gravity-val :lambda-list '(m))
(cl:defmethod gravity-val ((m <GetPhysicsProperties-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gazebo_msgs_new-srv:gravity-val is deprecated.  Use gazebo_msgs_new-srv:gravity instead.")
  (gravity m))

(cl:ensure-generic-function 'ode_config-val :lambda-list '(m))
(cl:defmethod ode_config-val ((m <GetPhysicsProperties-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gazebo_msgs_new-srv:ode_config-val is deprecated.  Use gazebo_msgs_new-srv:ode_config instead.")
  (ode_config m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetPhysicsProperties-response>)))
  ...
  "gazebo_msgs_new/GetPhysicsPropertiesResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetPhysicsProperties-response)))
  "Returns string type for a service object of type 'GetPhysicsProperties-response"
  "gazebo_msgs_new/GetPhysicsPropertiesResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetPhysicsProperties)))
  ...
  "gazebo_msgs_new/GetPhysicsProperties")