...
(cl:defmethod cl:initialize-instance :after ((m <SpawnModel-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SpawnModel-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gazebo_msgs_new-srv:<SpawnModel-request> is deprecated: use gazebo_msgs_new-srv:SpawnModel-request instead.")))
...
(cl:defmethod model_xml-val ((m <SpawnModel-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gazebo_msgs_new-srv:model_xml-val is deprecated.  Use gazebo_msgs_new-srv:model_xml instead.")
  (model_xml m))

(cl:ensure-generic-function 'robot_namespace-val :lambda-list '(m))
(cl:defmethod robot_namespace-val ((m <SpawnModel-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gazebo_msgs_new-srv:robot_namespace-val is deprecated.  Use gazebo_msgs_new-srv:robot_namespace instead.")
  (robot_namespace m))

(cl:ensure-generic-function 'initial_pose-val :lambda-list '(m))
(cl:defmethod initial_pose-val ((m <SpawnModel-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gazebo_msgs_new-srv:initial_pose-val is deprecated.  Use gazebo_msgs_new-srv:initial_pose instead.")
  (initial_pose m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SpawnModel-request>)))
  ...
  "gazebo_msgs_new/SpawnModelRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SpawnModel-request)))
  "Returns string type for a service object of type 'SpawnModel-request"
  "gazebo_msgs_new/SpawnModelRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SpawnModel-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SpawnModel-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gazebo_msgs_new-srv:<SpawnModel-response> is deprecated: use gazebo_msgs_new-srv:SpawnModel-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SpawnModel-response>)))
  ...
  "gazebo_msgs_new/SpawnModelResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SpawnModel-response)))
  "Returns string type for a service object of type 'SpawnModel-response"
  "gazebo_msgs_new/SpawnModelResponse")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SpawnModel-response>)))
  ...
  (cl:format cl:nil "bool success                      # return true if spawn successful~%string status_message             # comments if available~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SpawnModel-response)))
  "Returns full string definition for message of type 'SpawnModel-response"
  (cl:format cl:nil "bool success                      # return true if spawn successful~%string status_message             # comments if available~%~%~%~%"))
