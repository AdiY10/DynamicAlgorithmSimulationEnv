...
(cl:defmethod cl:initialize-instance :after ((m <GetModelState-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetModelState-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gazebo_msgs_new-srv:<GetModelState-request> is deprecated: use gazebo_msgs_new-srv:GetModelState-request instead.")))

(cl:ensure-generic-function 'model_name-val :lambda-list '(m))
(cl:defmethod model_name-val ((m <GetModelState-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gazebo_msgs_new-srv:model_name-val is deprecated.  Use gazebo_msgs_new-srv:model_name instead.")
  (model_name m))
...
(cl:defmethod relative_entity_name-val ((m <GetModelState-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gazebo_msgs_new-srv:relative_entity_name-val is deprecated.  Use gazebo_msgs_new-srv:relative_entity_name instead.")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetModelState-request>)))
  ...
  "gazebo_msgs_new/GetModelStateRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetModelState-request)))
  "Returns string type for a service object of type 'GetModelState-request"
  "gazebo_msgs_new/GetModelStateRequest")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<GetModelState-request>)))
  ...
  (cl:format cl:nil "string model_name                    # name of Gazebo Model~%string relative_entity_name          # return pose and twist relative to this entity~%                                     # an entity can be a model, body, or geom~%                                     # be sure to use gazebo scoped naming notation (e.g. [model_name::body_name])~%                                     # leave empty or \"world\" will use inertial world frame~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'GetModelState-request)))
  "Returns full string definition for message of type 'GetModelState-request"
  (cl:format cl:nil "string model_name                    # name of Gazebo Model~%string relative_entity_name          # return pose and twist relative to this entity~%                                     # an entity can be a model, body, or geom~%                                     # be sure to use gazebo scoped naming notation (e.g. [model_name::body_name])~%                                     # leave empty or \"world\" will use inertial world frame~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <GetModelState-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetModelState-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gazebo_msgs_new-srv:<GetModelState-response> is deprecated: use gazebo_msgs_new-srv:GetModelState-response instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <GetModelState-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gazebo_msgs_new-srv:header-val is deprecated.  Use gazebo_msgs_new-srv:header instead.")
  (header m))

(cl:ensure-generic-function 'pose-val :lambda-list '(m))
(cl:defmethod pose-val ((m <GetModelState-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gazebo_msgs_new-srv:pose-val is deprecated.  Use gazebo_msgs_new-srv:pose instead.")
  (pose m))

(cl:ensure-generic-function 'twist-val :lambda-list '(m))
(cl:defmethod twist-val ((m <GetModelState-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gazebo_msgs_new-srv:twist-val is deprecated.  Use gazebo_msgs_new-srv:twist instead.")
  (twist m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetModelState-response>)))
  ...
  "gazebo_msgs_new/GetModelStateResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetModelState-response)))
  "Returns string type for a service object of type 'GetModelState-response"
  "gazebo_msgs_new/GetModelStateResponse")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<GetModelState-response>)))
  ...
  (cl:format cl:nil "Header header                        # Standard metadata for higher-level stamped data types.~%                                     # * header.seq holds the number of requests since the plugin started~%                                     # * header.stamp timestamp related to the pose~%                                     # * header.frame_id not used but currently filled with the relative_entity_name~%geometry_msgs/Pose pose              # pose of model in relative entity frame~%geometry_msgs/Twist twist            # twist of model in relative entity frame~%bool success                         # return true if get successful~%string status_message                # comments if available~%~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%================================================================================~%MSG: geometry_msgs/Twist~%# This expresses velocity in free space broken into its linear and angular parts.~%Vector3  linear~%Vector3  angular~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'GetModelState-response)))
  "Returns full string definition for message of type 'GetModelState-response"
  (cl:format cl:nil "Header header                        # Standard metadata for higher-level stamped data types.~%                                     # * header.seq holds the number of requests since the plugin started~%                                     # * header.stamp timestamp related to the pose~%                                     # * header.frame_id not used but currently filled with the relative_entity_name~%geometry_msgs/Pose pose              # pose of model in relative entity frame~%geometry_msgs/Twist twist            # twist of model in relative entity frame~%bool success                         # return true if get successful~%string status_message                # comments if available~%~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%================================================================================~%MSG: geometry_msgs/Twist~%# This expresses velocity in free space broken into its linear and angular parts.~%Vector3  linear~%Vector3  angular~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%~%"))
