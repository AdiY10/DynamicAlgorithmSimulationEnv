...
(defsystem "gazebo_msgs_new-srv"
  :depends-on (:roslisp-msg-protocol :roslisp-utils :gazebo_msgs_new-msg
               :geometry_msgs-msg
               :std_msgs-msg
               :trajectory_msgs-msg
)
  :components ((:file "_package")
    ...
    (:file "DeleteLight" :depends-on ("_package_DeleteLight"))
    (:file "_package_DeleteLight" :depends-on ("_package"))
    ...
    (:file "GetLightProperties" :depends-on ("_package_GetLightProperties"))
    (:file "_package_GetLightProperties" :depends-on ("_package"))
    ...
    (:file "SetLightProperties" :depends-on ("_package_SetLightProperties"))
    (:file "_package_SetLightProperties" :depends-on ("_package"))
