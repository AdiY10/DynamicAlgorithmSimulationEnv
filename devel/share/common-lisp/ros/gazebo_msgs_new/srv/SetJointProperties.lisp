...
(cl:defclass <SetJointProperties-request> (roslisp-msg-protocol:ros-message)
  ((joint_name
   ...
   (ode_joint_config
    ...
    :type gazebo_msgs_new-msg:ODEJointProperties
    :initform (cl:make-instance 'gazebo_msgs_new-msg:ODEJointProperties)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <SetJointProperties-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetJointProperties-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gazebo_msgs_new-srv:<SetJointProperties-request> is deprecated: use gazebo_msgs_new-srv:SetJointProperties-request instead.")))

(cl:ensure-generic-function 'joint_name-val :lambda-list '(m))
(cl:defmethod joint_name-val ((m <SetJointProperties-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gazebo_msgs_new-srv:joint_name-val is deprecated.  Use gazebo_msgs_new-srv:joint_name instead.")
  (joint_name m))
...
(cl:defmethod ode_joint_config-val ((m <SetJointProperties-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gazebo_msgs_new-srv:ode_joint_config-val is deprecated.  Use gazebo_msgs_new-srv:ode_joint_config instead.")
  (ode_joint_config m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetJointProperties-request>)))
  ...
  "gazebo_msgs_new/SetJointPropertiesRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetJointProperties-request)))
  "Returns string type for a service object of type 'SetJointProperties-request"
  "gazebo_msgs_new/SetJointPropertiesRequest")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SetJointProperties-request>)))
  ...
  (cl:format cl:nil "string joint_name                               # name of joint~%gazebo_msgs_new/ODEJointProperties ode_joint_config # access to ODE joint dynamics properties~%~%================================================================================~%MSG: gazebo_msgs_new/ODEJointProperties~%# access to low level joint properties, change these at your own risk~%float64[] damping             # joint damping~%float64[] hiStop              # joint limit~%float64[] loStop              # joint limit~%float64[] erp                 # set joint erp~%float64[] cfm                 # set joint cfm~%float64[] stop_erp            # set joint erp for joint limit \"contact\" joint~%float64[] stop_cfm            # set joint cfm for joint limit \"contact\" joint~%float64[] fudge_factor        # joint fudge_factor applied at limits, see ODE manual for info.~%float64[] fmax                # ode joint param fmax~%float64[] vel                 # ode joint param vel~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SetJointProperties-request)))
  "Returns full string definition for message of type 'SetJointProperties-request"
  (cl:format cl:nil "string joint_name                               # name of joint~%gazebo_msgs_new/ODEJointProperties ode_joint_config # access to ODE joint dynamics properties~%~%================================================================================~%MSG: gazebo_msgs_new/ODEJointProperties~%# access to low level joint properties, change these at your own risk~%float64[] damping             # joint damping~%float64[] hiStop              # joint limit~%float64[] loStop              # joint limit~%float64[] erp                 # set joint erp~%float64[] cfm                 # set joint cfm~%float64[] stop_erp            # set joint erp for joint limit \"contact\" joint~%float64[] stop_cfm            # set joint cfm for joint limit \"contact\" joint~%float64[] fudge_factor        # joint fudge_factor applied at limits, see ODE manual for info.~%float64[] fmax                # ode joint param fmax~%float64[] vel                 # ode joint param vel~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <SetJointProperties-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetJointProperties-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gazebo_msgs_new-srv:<SetJointProperties-response> is deprecated: use gazebo_msgs_new-srv:SetJointProperties-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetJointProperties-response>)))
  ...
  "gazebo_msgs_new/SetJointPropertiesResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetJointProperties-response)))
  "Returns string type for a service object of type 'SetJointProperties-response"
  "gazebo_msgs_new/SetJointPropertiesResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetJointProperties)))
  ...
  "gazebo_msgs_new/SetJointProperties")