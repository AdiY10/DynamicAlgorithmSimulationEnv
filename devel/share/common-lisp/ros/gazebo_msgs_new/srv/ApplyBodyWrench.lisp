...
(cl:defmethod cl:initialize-instance :after ((m <ApplyBodyWrench-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ApplyBodyWrench-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gazebo_msgs_new-srv:<ApplyBodyWrench-request> is deprecated: use gazebo_msgs_new-srv:ApplyBodyWrench-request instead.")))

(cl:ensure-generic-function 'body_name-val :lambda-list '(m))
(cl:defmethod body_name-val ((m <ApplyBodyWrench-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gazebo_msgs_new-srv:body_name-val is deprecated.  Use gazebo_msgs_new-srv:body_name instead.")
  (body_name m))

(cl:ensure-generic-function 'reference_frame-val :lambda-list '(m))
(cl:defmethod reference_frame-val ((m <ApplyBodyWrench-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gazebo_msgs_new-srv:reference_frame-val is deprecated.  Use gazebo_msgs_new-srv:reference_frame instead.")
  (reference_frame m))

(cl:ensure-generic-function 'reference_point-val :lambda-list '(m))
(cl:defmethod reference_point-val ((m <ApplyBodyWrench-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gazebo_msgs_new-srv:reference_point-val is deprecated.  Use gazebo_msgs_new-srv:reference_point instead.")
  (reference_point m))

(cl:ensure-generic-function 'wrench-val :lambda-list '(m))
(cl:defmethod wrench-val ((m <ApplyBodyWrench-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gazebo_msgs_new-srv:wrench-val is deprecated.  Use gazebo_msgs_new-srv:wrench instead.")
  (wrench m))

(cl:ensure-generic-function 'start_time-val :lambda-list '(m))
(cl:defmethod start_time-val ((m <ApplyBodyWrench-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gazebo_msgs_new-srv:start_time-val is deprecated.  Use gazebo_msgs_new-srv:start_time instead.")
  (start_time m))

(cl:ensure-generic-function 'duration-val :lambda-list '(m))
(cl:defmethod duration-val ((m <ApplyBodyWrench-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gazebo_msgs_new-srv:duration-val is deprecated.  Use gazebo_msgs_new-srv:duration instead.")
  (duration m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ApplyBodyWrench-request>)))
  ...
  "gazebo_msgs_new/ApplyBodyWrenchRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ApplyBodyWrench-request)))
  "Returns string type for a service object of type 'ApplyBodyWrench-request"
  "gazebo_msgs_new/ApplyBodyWrenchRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <ApplyBodyWrench-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ApplyBodyWrench-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gazebo_msgs_new-srv:<ApplyBodyWrench-response> is deprecated: use gazebo_msgs_new-srv:ApplyBodyWrench-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ApplyBodyWrench-response>)))
  ...
  "gazebo_msgs_new/ApplyBodyWrenchResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ApplyBodyWrench-response)))
  "Returns string type for a service object of type 'ApplyBodyWrench-response"
  "gazebo_msgs_new/ApplyBodyWrenchResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ApplyBodyWrench)))
  ...
  "gazebo_msgs_new/ApplyBodyWrench")