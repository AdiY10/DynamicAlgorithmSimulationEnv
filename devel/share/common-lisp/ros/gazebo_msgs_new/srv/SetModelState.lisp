...
(cl:defclass <SetModelState-request> (roslisp-msg-protocol:ros-message)
  ((model_state
    :reader model_state
    :initarg :model_state
    :type gazebo_msgs_new-msg:ModelState
    :initform (cl:make-instance 'gazebo_msgs_new-msg:ModelState)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <SetModelState-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetModelState-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gazebo_msgs_new-srv:<SetModelState-request> is deprecated: use gazebo_msgs_new-srv:SetModelState-request instead.")))

(cl:ensure-generic-function 'model_state-val :lambda-list '(m))
(cl:defmethod model_state-val ((m <SetModelState-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gazebo_msgs_new-srv:model_state-val is deprecated.  Use gazebo_msgs_new-srv:model_state instead.")
  (model_state m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetModelState-request>)))
  ...
  "gazebo_msgs_new/SetModelStateRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetModelState-request)))
  "Returns string type for a service object of type 'SetModelState-request"
  "gazebo_msgs_new/SetModelStateRequest")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SetModelState-request>)))
  ...
  (cl:format cl:nil "gazebo_msgs_new/ModelState model_state~%~%================================================================================~%MSG: gazebo_msgs_new/ModelState~%# Set Gazebo Model pose and twist~%string model_name           # model to set state (pose and twist)~%geometry_msgs/Pose pose     # desired pose in reference frame~%geometry_msgs/Twist twist   # desired twist in reference frame~%string reference_frame      # set pose/twist relative to the frame of this entity (Body/Model)~%                            # leave empty or \"world\" or \"map\" defaults to world-frame~%~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%================================================================================~%MSG: geometry_msgs/Twist~%# This expresses velocity in free space broken into its linear and angular parts.~%Vector3  linear~%Vector3  angular~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SetModelState-request)))
  "Returns full string definition for message of type 'SetModelState-request"
  (cl:format cl:nil "gazebo_msgs_new/ModelState model_state~%~%================================================================================~%MSG: gazebo_msgs_new/ModelState~%# Set Gazebo Model pose and twist~%string model_name           # model to set state (pose and twist)~%geometry_msgs/Pose pose     # desired pose in reference frame~%geometry_msgs/Twist twist   # desired twist in reference frame~%string reference_frame      # set pose/twist relative to the frame of this entity (Body/Model)~%                            # leave empty or \"world\" or \"map\" defaults to world-frame~%~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%================================================================================~%MSG: geometry_msgs/Twist~%# This expresses velocity in free space broken into its linear and angular parts.~%Vector3  linear~%Vector3  angular~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <SetModelState-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetModelState-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gazebo_msgs_new-srv:<SetModelState-response> is deprecated: use gazebo_msgs_new-srv:SetModelState-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetModelState-response>)))
  ...
  "gazebo_msgs_new/SetModelStateResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetModelState-response)))
  "Returns string type for a service object of type 'SetModelState-response"
  "gazebo_msgs_new/SetModelStateResponse")
