...
(cl:defmethod cl:initialize-instance :after ((m <SetJointTrajectory-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetJointTrajectory-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gazebo_msgs_new-srv:<SetJointTrajectory-request> is deprecated: use gazebo_msgs_new-srv:SetJointTrajectory-request instead.")))
...
(cl:defmethod joint_trajectory-val ((m <SetJointTrajectory-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gazebo_msgs_new-srv:joint_trajectory-val is deprecated.  Use gazebo_msgs_new-srv:joint_trajectory instead.")
  (joint_trajectory m))

(cl:ensure-generic-function 'model_pose-val :lambda-list '(m))
(cl:defmethod model_pose-val ((m <SetJointTrajectory-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gazebo_msgs_new-srv:model_pose-val is deprecated.  Use gazebo_msgs_new-srv:model_pose instead.")
  (model_pose m))

(cl:ensure-generic-function 'set_model_pose-val :lambda-list '(m))
(cl:defmethod set_model_pose-val ((m <SetJointTrajectory-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gazebo_msgs_new-srv:set_model_pose-val is deprecated.  Use gazebo_msgs_new-srv:set_model_pose instead.")
  (set_model_pose m))
...
(cl:defmethod disable_physics_updates-val ((m <SetJointTrajectory-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gazebo_msgs_new-srv:disable_physics_updates-val is deprecated.  Use gazebo_msgs_new-srv:disable_physics_updates instead.")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetJointTrajectory-request>)))
  ...
  "gazebo_msgs_new/SetJointTrajectoryRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetJointTrajectory-request)))
  "Returns string type for a service object of type 'SetJointTrajectory-request"
  "gazebo_msgs_new/SetJointTrajectoryRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SetJointTrajectory-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetJointTrajectory-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gazebo_msgs_new-srv:<SetJointTrajectory-response> is deprecated: use gazebo_msgs_new-srv:SetJointTrajectory-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetJointTrajectory-response>)))
  ...
  "gazebo_msgs_new/SetJointTrajectoryResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetJointTrajectory-response)))
  "Returns string type for a service object of type 'SetJointTrajectory-response"
  "gazebo_msgs_new/SetJointTrajectoryResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetJointTrajectory)))
  ...
  "gazebo_msgs_new/SetJointTrajectory")