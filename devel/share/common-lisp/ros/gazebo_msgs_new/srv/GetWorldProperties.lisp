...
(cl:defmethod cl:initialize-instance :after ((m <GetWorldProperties-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetWorldProperties-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gazebo_msgs_new-srv:<GetWorldProperties-request> is deprecated: use gazebo_msgs_new-srv:GetWorldProperties-request instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetWorldProperties-request>)))
  ...
  "gazebo_msgs_new/GetWorldPropertiesRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetWorldProperties-request)))
  "Returns string type for a service object of type 'GetWorldProperties-request"
  "gazebo_msgs_new/GetWorldPropertiesRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <GetWorldProperties-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetWorldProperties-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gazebo_msgs_new-srv:<GetWorldProperties-response> is deprecated: use gazebo_msgs_new-srv:GetWorldProperties-response instead.")))

(cl:ensure-generic-function 'sim_time-val :lambda-list '(m))
(cl:defmethod sim_time-val ((m <GetWorldProperties-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gazebo_msgs_new-srv:sim_time-val is deprecated.  Use gazebo_msgs_new-srv:sim_time instead.")
  (sim_time m))

(cl:ensure-generic-function 'model_names-val :lambda-list '(m))
(cl:defmethod model_names-val ((m <GetWorldProperties-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gazebo_msgs_new-srv:model_names-val is deprecated.  Use gazebo_msgs_new-srv:model_names instead.")
  (model_names m))
...
(cl:defmethod rendering_enabled-val ((m <GetWorldProperties-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gazebo_msgs_new-srv:rendering_enabled-val is deprecated.  Use gazebo_msgs_new-srv:rendering_enabled instead.")
  (rendering_enabled m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetWorldProperties-response>)))
  ...
  "gazebo_msgs_new/GetWorldPropertiesResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetWorldProperties-response)))
  "Returns string type for a service object of type 'GetWorldProperties-response"
  "gazebo_msgs_new/GetWorldPropertiesResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetWorldProperties)))
  ...
  "gazebo_msgs_new/GetWorldProperties")