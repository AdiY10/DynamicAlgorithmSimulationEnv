...
(cl:defmethod cl:initialize-instance :after ((m <GetLinkState-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetLinkState-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gazebo_msgs_new-srv:<GetLinkState-request> is deprecated: use gazebo_msgs_new-srv:GetLinkState-request instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetLinkState-request>)))
  ...
  "gazebo_msgs_new/GetLinkStateRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetLinkState-request)))
  "Returns string type for a service object of type 'GetLinkState-request"
  "gazebo_msgs_new/GetLinkStateRequest")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<GetLinkState-request>)))
  ...
  (cl:format cl:nil "string link_name          # name of link~%                          # link names are prefixed by model name, e.g. pr2::base_link~%string reference_frame    # reference frame of returned information, must be a valid link~%                          # if empty, use inertial (gazebo world) frame~%                          # reference_frame names are prefixed by model name, e.g. pr2::base_link~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'GetLinkState-request)))
  "Returns full string definition for message of type 'GetLinkState-request"
  (cl:format cl:nil "string link_name          # name of link~%                          # link names are prefixed by model name, e.g. pr2::base_link~%string reference_frame    # reference frame of returned information, must be a valid link~%                          # if empty, use inertial (gazebo world) frame~%                          # reference_frame names are prefixed by model name, e.g. pr2::base_link~%~%~%"))
...
(cl:defclass <GetLinkState-response> (roslisp-msg-protocol:ros-message)
  ((link_state
    :reader link_state
    :initarg :link_state
    :type gazebo_msgs_new-msg:LinkState
    :initform (cl:make-instance 'gazebo_msgs_new-msg:LinkState))
   (success
    :reader success
    :initarg :success
    :type cl:boolean
...
(cl:defmethod cl:initialize-instance :after ((m <GetLinkState-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetLinkState-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gazebo_msgs_new-srv:<GetLinkState-response> is deprecated: use gazebo_msgs_new-srv:GetLinkState-response instead.")))

(cl:ensure-generic-function 'link_state-val :lambda-list '(m))
(cl:defmethod link_state-val ((m <GetLinkState-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gazebo_msgs_new-srv:link_state-val is deprecated.  Use gazebo_msgs_new-srv:link_state instead.")
  (link_state m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetLinkState-response>)))
  ...
  "gazebo_msgs_new/GetLinkStateResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetLinkState-response)))
  "Returns string type for a service object of type 'GetLinkState-response"
  "gazebo_msgs_new/GetLinkStateResponse")
