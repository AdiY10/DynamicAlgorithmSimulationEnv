...
(cl:defmethod cl:initialize-instance :after ((m <ModelState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ModelState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gazebo_msgs_new-msg:<ModelState> is deprecated: use gazebo_msgs_new-msg:ModelState instead.")))

(cl:ensure-generic-function 'model_name-val :lambda-list '(m))
(cl:defmethod model_name-val ((m <ModelState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gazebo_msgs_new-msg:model_name-val is deprecated.  Use gazebo_msgs_new-msg:model_name instead.")
  (model_name m))
...
(cl:defmethod reference_frame-val ((m <ModelState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gazebo_msgs_new-msg:reference_frame-val is deprecated.  Use gazebo_msgs_new-msg:reference_frame instead.")
  (reference_frame m))
