...
(cl:defmethod cl:initialize-instance :after ((m <LinkState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LinkState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gazebo_msgs_new-msg:<LinkState> is deprecated: use gazebo_msgs_new-msg:LinkState instead.")))

(cl:ensure-generic-function 'link_name-val :lambda-list '(m))
(cl:defmethod link_name-val ((m <LinkState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gazebo_msgs_new-msg:link_name-val is deprecated.  Use gazebo_msgs_new-msg:link_name instead.")
  (link_name m))
