...
(cl:in-package summit_xl_pad_new-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <enable_disable_pad-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'enable_disable_pad-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name summit_xl_pad_new-srv:<enable_disable_pad-request> is deprecated: use summit_xl_pad_new-srv:enable_disable_pad-request instead.")))

(cl:ensure-generic-function 'value-val :lambda-list '(m))
(cl:defmethod value-val ((m <enable_disable_pad-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader summit_xl_pad_new-srv:value-val is deprecated.  Use summit_xl_pad_new-srv:value instead.")
  (value m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<enable_disable_pad-request>)))
  ...
  "summit_xl_pad_new/enable_disable_padRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'enable_disable_pad-request)))
  "Returns string type for a service object of type 'enable_disable_pad-request"
  "summit_xl_pad_new/enable_disable_padRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <enable_disable_pad-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'enable_disable_pad-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name summit_xl_pad_new-srv:<enable_disable_pad-response> is deprecated: use summit_xl_pad_new-srv:enable_disable_pad-response instead.")))

(cl:ensure-generic-function 'ret-val :lambda-list '(m))
(cl:defmethod ret-val ((m <enable_disable_pad-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader summit_xl_pad_new-srv:ret-val is deprecated.  Use summit_xl_pad_new-srv:ret instead.")
  (ret m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<enable_disable_pad-response>)))
  ...
  "summit_xl_pad_new/enable_disable_padResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'enable_disable_pad-response)))
  "Returns string type for a service object of type 'enable_disable_pad-response"
  "summit_xl_pad_new/enable_disable_padResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'enable_disable_pad)))
  ...
  "summit_xl_pad_new/enable_disable_pad")