...
class SetElevatorRequest {
  ...
  static datatype() {
    ...
    return 'robotnik_msgs_new/SetElevatorRequest';
  }
  ...
  static messageDefinition() {
    ...
    return `
    robotnik_msgs_new/ElevatorAction action
    
    ================================================================================
    MSG: robotnik_msgs_new/ElevatorAction
    int32 RAISE=1
    int32 LOWER=-1
    int32 STOP=0
...
class SetElevatorResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'robotnik_msgs_new/SetElevatorResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'robotnik_msgs_new/SetElevator'; }
};
