...
class InsertTaskRequest {
  ...
  static getMessageSize(object) {
    let length = 0;
    length += object.description_task.length;
    length += object.datatime_start.length;
    return length + 12;
  }

  static datatype() {
    // Returns string type for a service object
    return 'robotnik_msgs_new/InsertTaskRequest';
  }
...
class InsertTaskResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'robotnik_msgs_new/InsertTaskResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'robotnik_msgs_new/InsertTask'; }
};
