...
class SetMotorPIDRequest {
  ...
  static datatype() {
    ...
    return 'robotnik_msgs_new/SetMotorPIDRequest';
  }
  ...
  static messageDefinition() {
    ...
    ================================================================================
    MSG: robotnik_msgs_new/MotorPID
...
class SetMotorPIDResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'robotnik_msgs_new/SetMotorPIDResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'robotnik_msgs_new/SetMotorPID'; }
};
