...
class get_modbus_registerRequest {
  ...
  static datatype() {
    ...
    return 'robotnik_msgs_new/get_modbus_registerRequest';
  }
...
class get_modbus_registerResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'robotnik_msgs_new/get_modbus_registerResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'robotnik_msgs_new/get_modbus_register'; }
};
