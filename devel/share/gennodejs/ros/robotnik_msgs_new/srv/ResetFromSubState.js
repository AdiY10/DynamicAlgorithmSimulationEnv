...
class ResetFromSubStateRequest {
  ...
  static datatype() {
    ...
    return 'robotnik_msgs_new/ResetFromSubStateRequest';
  }
...
class ResetFromSubStateResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'robotnik_msgs_new/ResetFromSubStateResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'robotnik_msgs_new/ResetFromSubState'; }
};
