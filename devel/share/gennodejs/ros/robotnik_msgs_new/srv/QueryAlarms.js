...
// (in-package robotnik_msgs_new.srv)
...
class QueryAlarmsRequest {
  ...
  static getMessageSize(object) {
    let length = 0;
    length += object.type_query.length;
    length += object.start_date.length;
    length += object.end_date.length;
    length += object.filter_type.length;
    return length + 20;
  }

  static datatype() {
    // Returns string type for a service object
    return 'robotnik_msgs_new/QueryAlarmsRequest';
  }
...
class QueryAlarmsResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'robotnik_msgs_new/QueryAlarmsResponse';
  }
  ...
  static messageDefinition() {
    ...
    ================================================================================
    MSG: robotnik_msgs_new/QueryAlarm
    int32 alm_id
...
module.exports = {
  ...
  datatype() { return 'robotnik_msgs_new/QueryAlarms'; }
};
