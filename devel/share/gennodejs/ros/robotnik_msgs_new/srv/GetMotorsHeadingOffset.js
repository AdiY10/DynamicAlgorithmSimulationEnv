...
class GetMotorsHeadingOffsetRequest {
  ...
  static datatype() {
    ...
    return 'robotnik_msgs_new/GetMotorsHeadingOffsetRequest';
  }
...
class GetMotorsHeadingOffsetResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'robotnik_msgs_new/GetMotorsHeadingOffsetResponse';
  }
  ...
  static messageDefinition() {
    // Returns full string definition for message
    return `
    robotnik_msgs_new/MotorHeadingOffset[] offsets
    
    
    ================================================================================
    MSG: robotnik_msgs_new/MotorHeadingOffset
    int32 motor
    float64 value
...
module.exports = {
  ...
  datatype() { return 'robotnik_msgs_new/GetMotorsHeadingOffset'; }
};
