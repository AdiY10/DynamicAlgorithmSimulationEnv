...
class SetEncoderTurnsRequest {
  ...
  static datatype() {
    ...
    return 'robotnik_msgs_new/SetEncoderTurnsRequest';
  }
  ...
  static messageDefinition() {
    ...
    return `
    robotnik_msgs_new/MotorHeadingOffset encoder_turns
...
class SetEncoderTurnsResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'robotnik_msgs_new/SetEncoderTurnsResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'robotnik_msgs_new/SetEncoderTurns'; }
};
