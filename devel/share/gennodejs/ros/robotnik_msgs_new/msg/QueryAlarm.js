...
class QueryAlarm {
  ...
  static getMessageSize(object) {
    let length = 0;
    length += object.alm_component.length;
    length += object.alm_type.length;
    length += object.alm_group.length;
    length += object.alm_description.length;
    length += object.alm_start_time.length;
    length += object.alm_end_time.length;
    return length + 28;
  }

  static datatype() {
    // Returns string type for a message object
    return 'robotnik_msgs_new/QueryAlarm';
  }
