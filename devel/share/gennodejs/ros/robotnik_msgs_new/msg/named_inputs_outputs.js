...
class named_inputs_outputs {
  ...
  static datatype() {
    ...
    return 'robotnik_msgs_new/named_inputs_outputs';
  }
  ...
  static messageDefinition() {
    ...
    return `
    robotnik_msgs_new/named_input_output[] digital_inputs
    robotnik_msgs_new/named_input_output[] digital_outputs
    ================================================================================
    MSG: robotnik_msgs_new/named_input_output
    string name
    bool value
    `;
  }
