...
// (in-package summit_xl_pad_new.srv)
...
class enable_disable_padRequest {
  ...
  static datatype() {
    ...
    return 'summit_xl_pad_new/enable_disable_padRequest';
  }
...
class enable_disable_padResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'summit_xl_pad_new/enable_disable_padResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'summit_xl_pad_new/enable_disable_pad'; }
};
