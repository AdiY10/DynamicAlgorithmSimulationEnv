...
class SetPhysicsPropertiesRequest {
  ...
  static datatype() {
    ...
    return 'gazebo_msgs_new/SetPhysicsPropertiesRequest';
  }
  ...
  static messageDefinition() {
    ...
    gazebo_msgs_new/ODEPhysics ode_config  # configurations for ODE
...
class SetPhysicsPropertiesResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'gazebo_msgs_new/SetPhysicsPropertiesResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'gazebo_msgs_new/SetPhysicsProperties'; }
};
