...
class GetPhysicsPropertiesRequest {
  ...
  static datatype() {
    ...
    return 'gazebo_msgs_new/GetPhysicsPropertiesRequest';
  }
...
class GetPhysicsPropertiesResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'gazebo_msgs_new/GetPhysicsPropertiesResponse';
  }
  ...
  static messageDefinition() {
    ...
    gazebo_msgs_new/ODEPhysics ode_config  # contains physics configurations pertaining to ODE
    ...
    float64 z
    ================================================================================
    MSG: gazebo_msgs_new/ODEPhysics
...
module.exports = {
  ...
  datatype() { return 'gazebo_msgs_new/GetPhysicsProperties'; }
};
