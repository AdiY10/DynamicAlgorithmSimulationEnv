...
class SetLinkStateRequest {
  ...
  static datatype() {
    ...
    return 'gazebo_msgs_new/SetLinkStateRequest';
  }
  ...
  static messageDefinition() {
    ...
    return `
    gazebo_msgs_new/LinkState link_state
    
    ================================================================================
    MSG: gazebo_msgs_new/LinkState
...
class SetLinkStateResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'gazebo_msgs_new/SetLinkStateResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'gazebo_msgs_new/SetLinkState'; }
};
