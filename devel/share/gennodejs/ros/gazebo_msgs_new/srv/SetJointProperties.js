...
class SetJointPropertiesRequest {
  ...
  static datatype() {
    ...
    return 'gazebo_msgs_new/SetJointPropertiesRequest';
  }
  ...
  static messageDefinition() {
    ...
    gazebo_msgs_new/ODEJointProperties ode_joint_config # access to ODE joint dynamics properties
    
    ================================================================================
    MSG: gazebo_msgs_new/ODEJointProperties
...
class SetJointPropertiesResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'gazebo_msgs_new/SetJointPropertiesResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'gazebo_msgs_new/SetJointProperties'; }
};
