// Generated by gencpp from file ur_msgs_new/RobotStateRTMsg.msg
// DO NOT EDIT!


#ifndef UR_MSGS_NEW_MESSAGE_ROBOTSTATERTMSG_H
#define UR_MSGS_NEW_MESSAGE_ROBOTSTATERTMSG_H
...
struct RobotStateRTMsg_
{
  ...
  typedef boost::shared_ptr< ::ur_msgs_new::RobotStateRTMsg_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::ur_msgs_new::RobotStateRTMsg_<ContainerAllocator> const> ConstPtr;

}; // struct RobotStateRTMsg_

typedef ::ur_msgs_new::RobotStateRTMsg_<std::allocator<void> > RobotStateRTMsg;

typedef boost::shared_ptr< ::ur_msgs_new::RobotStateRTMsg > RobotStateRTMsgPtr;
typedef boost::shared_ptr< ::ur_msgs_new::RobotStateRTMsg const> RobotStateRTMsgConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::ur_msgs_new::RobotStateRTMsg_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::ur_msgs_new::RobotStateRTMsg_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::ur_msgs_new::RobotStateRTMsg_<ContainerAllocator1> & lhs, const ::ur_msgs_new::RobotStateRTMsg_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::ur_msgs_new::RobotStateRTMsg_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::ur_msgs_new::RobotStateRTMsg_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ur_msgs_new::RobotStateRTMsg_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ur_msgs_new::RobotStateRTMsg_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ur_msgs_new::RobotStateRTMsg_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ur_msgs_new::RobotStateRTMsg_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::ur_msgs_new::RobotStateRTMsg_<ContainerAllocator> >
{
  ...
  static const char* value(const ::ur_msgs_new::RobotStateRTMsg_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xce6feddd3ccb4ca7ULL;
  static const uint64_t static_value2 = 0xdbcd0ff105b603c7ULL;
};

template<class ContainerAllocator>
struct DataType< ::ur_msgs_new::RobotStateRTMsg_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::ur_msgs_new::RobotStateRTMsg_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::ur_msgs_new::RobotStateRTMsg_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::ur_msgs_new::RobotStateRTMsg_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::ur_msgs_new::RobotStateRTMsg_<ContainerAllocator>& v)
  {
    s << indent << "time: ";
...
#endif // UR_MSGS_NEW_MESSAGE_ROBOTSTATERTMSG_H
