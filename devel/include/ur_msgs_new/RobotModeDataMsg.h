// Generated by gencpp from file ur_msgs_new/RobotModeDataMsg.msg
// DO NOT EDIT!


#ifndef UR_MSGS_NEW_MESSAGE_ROBOTMODEDATAMSG_H
#define UR_MSGS_NEW_MESSAGE_ROBOTMODEDATAMSG_H
...
struct RobotModeDataMsg_
{
  ...
  typedef boost::shared_ptr< ::ur_msgs_new::RobotModeDataMsg_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::ur_msgs_new::RobotModeDataMsg_<ContainerAllocator> const> ConstPtr;

}; // struct RobotModeDataMsg_

typedef ::ur_msgs_new::RobotModeDataMsg_<std::allocator<void> > RobotModeDataMsg;

typedef boost::shared_ptr< ::ur_msgs_new::RobotModeDataMsg > RobotModeDataMsgPtr;
typedef boost::shared_ptr< ::ur_msgs_new::RobotModeDataMsg const> RobotModeDataMsgConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::ur_msgs_new::RobotModeDataMsg_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::ur_msgs_new::RobotModeDataMsg_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::ur_msgs_new::RobotModeDataMsg_<ContainerAllocator1> & lhs, const ::ur_msgs_new::RobotModeDataMsg_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::ur_msgs_new::RobotModeDataMsg_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::ur_msgs_new::RobotModeDataMsg_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ur_msgs_new::RobotModeDataMsg_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ur_msgs_new::RobotModeDataMsg_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ur_msgs_new::RobotModeDataMsg_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ur_msgs_new::RobotModeDataMsg_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::ur_msgs_new::RobotModeDataMsg_<ContainerAllocator> >
{
  ...
  static const char* value(const ::ur_msgs_new::RobotModeDataMsg_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x867308ca39e2cc06ULL;
  static const uint64_t static_value2 = 0x44b50db27deb661fULL;
};

template<class ContainerAllocator>
struct DataType< ::ur_msgs_new::RobotModeDataMsg_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::ur_msgs_new::RobotModeDataMsg_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::ur_msgs_new::RobotModeDataMsg_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::ur_msgs_new::RobotModeDataMsg_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::ur_msgs_new::RobotModeDataMsg_<ContainerAllocator>& v)
  {
    s << indent << "timestamp: ";
...
#endif // UR_MSGS_NEW_MESSAGE_ROBOTMODEDATAMSG_H
