// Generated by gencpp from file ur_msgs_new/MasterboardDataMsg.msg
// DO NOT EDIT!


#ifndef UR_MSGS_NEW_MESSAGE_MASTERBOARDDATAMSG_H
#define UR_MSGS_NEW_MESSAGE_MASTERBOARDDATAMSG_H
...
struct MasterboardDataMsg_
{
  ...
  typedef boost::shared_ptr< ::ur_msgs_new::MasterboardDataMsg_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::ur_msgs_new::MasterboardDataMsg_<ContainerAllocator> const> ConstPtr;

}; // struct MasterboardDataMsg_

typedef ::ur_msgs_new::MasterboardDataMsg_<std::allocator<void> > MasterboardDataMsg;

typedef boost::shared_ptr< ::ur_msgs_new::MasterboardDataMsg > MasterboardDataMsgPtr;
typedef boost::shared_ptr< ::ur_msgs_new::MasterboardDataMsg const> MasterboardDataMsgConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::ur_msgs_new::MasterboardDataMsg_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::ur_msgs_new::MasterboardDataMsg_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::ur_msgs_new::MasterboardDataMsg_<ContainerAllocator1> & lhs, const ::ur_msgs_new::MasterboardDataMsg_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::ur_msgs_new::MasterboardDataMsg_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::ur_msgs_new::MasterboardDataMsg_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ur_msgs_new::MasterboardDataMsg_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ur_msgs_new::MasterboardDataMsg_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ur_msgs_new::MasterboardDataMsg_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ur_msgs_new::MasterboardDataMsg_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::ur_msgs_new::MasterboardDataMsg_<ContainerAllocator> >
{
  ...
  static const char* value(const ::ur_msgs_new::MasterboardDataMsg_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x807af5dc427082b1ULL;
  static const uint64_t static_value2 = 0x11fa23d1fd2cd585ULL;
};

template<class ContainerAllocator>
struct DataType< ::ur_msgs_new::MasterboardDataMsg_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::ur_msgs_new::MasterboardDataMsg_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::ur_msgs_new::MasterboardDataMsg_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::ur_msgs_new::MasterboardDataMsg_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::ur_msgs_new::MasterboardDataMsg_<ContainerAllocator>& v)
  {
...
#endif // UR_MSGS_NEW_MESSAGE_MASTERBOARDDATAMSG_H
