// Generated by gencpp from file gazebo_msgs_new/ODEJointProperties.msg
// DO NOT EDIT!


#ifndef GAZEBO_MSGS_NEW_MESSAGE_ODEJOINTPROPERTIES_H
#define GAZEBO_MSGS_NEW_MESSAGE_ODEJOINTPROPERTIES_H
...
struct ODEJointProperties_
{
  ...
  typedef boost::shared_ptr< ::gazebo_msgs_new::ODEJointProperties_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::gazebo_msgs_new::ODEJointProperties_<ContainerAllocator> const> ConstPtr;

}; // struct ODEJointProperties_

typedef ::gazebo_msgs_new::ODEJointProperties_<std::allocator<void> > ODEJointProperties;

typedef boost::shared_ptr< ::gazebo_msgs_new::ODEJointProperties > ODEJointPropertiesPtr;
typedef boost::shared_ptr< ::gazebo_msgs_new::ODEJointProperties const> ODEJointPropertiesConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::gazebo_msgs_new::ODEJointProperties_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::gazebo_msgs_new::ODEJointProperties_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::gazebo_msgs_new::ODEJointProperties_<ContainerAllocator1> & lhs, const ::gazebo_msgs_new::ODEJointProperties_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::gazebo_msgs_new::ODEJointProperties_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::gazebo_msgs_new::ODEJointProperties_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::gazebo_msgs_new::ODEJointProperties_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::gazebo_msgs_new::ODEJointProperties_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::gazebo_msgs_new::ODEJointProperties_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::gazebo_msgs_new::ODEJointProperties_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::gazebo_msgs_new::ODEJointProperties_<ContainerAllocator> >
{
  ...
  static const char* value(const ::gazebo_msgs_new::ODEJointProperties_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x1b744c32a920af97ULL;
  static const uint64_t static_value2 = 0x9f53afe2f9c3511fULL;
};

template<class ContainerAllocator>
struct DataType< ::gazebo_msgs_new::ODEJointProperties_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::gazebo_msgs_new::ODEJointProperties_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::gazebo_msgs_new::ODEJointProperties_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::gazebo_msgs_new::ODEJointProperties_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::gazebo_msgs_new::ODEJointProperties_<ContainerAllocator>& v)
  {
...
#endif // GAZEBO_MSGS_NEW_MESSAGE_ODEJOINTPROPERTIES_H
