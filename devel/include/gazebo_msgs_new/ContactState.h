// Generated by gencpp from file gazebo_msgs_new/ContactState.msg
// DO NOT EDIT!


#ifndef GAZEBO_MSGS_NEW_MESSAGE_CONTACTSTATE_H
#define GAZEBO_MSGS_NEW_MESSAGE_CONTACTSTATE_H
...
struct ContactState_
{
  ...
  typedef boost::shared_ptr< ::gazebo_msgs_new::ContactState_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::gazebo_msgs_new::ContactState_<ContainerAllocator> const> ConstPtr;

}; // struct ContactState_

typedef ::gazebo_msgs_new::ContactState_<std::allocator<void> > ContactState;

typedef boost::shared_ptr< ::gazebo_msgs_new::ContactState > ContactStatePtr;
typedef boost::shared_ptr< ::gazebo_msgs_new::ContactState const> ContactStateConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::gazebo_msgs_new::ContactState_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::gazebo_msgs_new::ContactState_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::gazebo_msgs_new::ContactState_<ContainerAllocator1> & lhs, const ::gazebo_msgs_new::ContactState_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::gazebo_msgs_new::ContactState_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::gazebo_msgs_new::ContactState_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::gazebo_msgs_new::ContactState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::gazebo_msgs_new::ContactState_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::gazebo_msgs_new::ContactState_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::gazebo_msgs_new::ContactState_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::gazebo_msgs_new::ContactState_<ContainerAllocator> >
{
  ...
  static const char* value(const ::gazebo_msgs_new::ContactState_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x48c0ffb054b8c444ULL;
  static const uint64_t static_value2 = 0xf870cecea1ee50d9ULL;
};

template<class ContainerAllocator>
struct DataType< ::gazebo_msgs_new::ContactState_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::gazebo_msgs_new::ContactState_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::gazebo_msgs_new::ContactState_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::gazebo_msgs_new::ContactState_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::gazebo_msgs_new::ContactState_<ContainerAllocator>& v)
  {
    s << indent << "info: ";
...
#endif // GAZEBO_MSGS_NEW_MESSAGE_CONTACTSTATE_H
