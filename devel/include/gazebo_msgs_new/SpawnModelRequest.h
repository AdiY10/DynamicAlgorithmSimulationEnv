// Generated by gencpp from file gazebo_msgs_new/SpawnModelRequest.msg
// DO NOT EDIT!


#ifndef GAZEBO_MSGS_NEW_MESSAGE_SPAWNMODELREQUEST_H
#define GAZEBO_MSGS_NEW_MESSAGE_SPAWNMODELREQUEST_H
...
struct SpawnModelRequest_
{
  ...
  typedef boost::shared_ptr< ::gazebo_msgs_new::SpawnModelRequest_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::gazebo_msgs_new::SpawnModelRequest_<ContainerAllocator> const> ConstPtr;

}; // struct SpawnModelRequest_

typedef ::gazebo_msgs_new::SpawnModelRequest_<std::allocator<void> > SpawnModelRequest;

typedef boost::shared_ptr< ::gazebo_msgs_new::SpawnModelRequest > SpawnModelRequestPtr;
typedef boost::shared_ptr< ::gazebo_msgs_new::SpawnModelRequest const> SpawnModelRequestConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::gazebo_msgs_new::SpawnModelRequest_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::gazebo_msgs_new::SpawnModelRequest_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::gazebo_msgs_new::SpawnModelRequest_<ContainerAllocator1> & lhs, const ::gazebo_msgs_new::SpawnModelRequest_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::gazebo_msgs_new::SpawnModelRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::gazebo_msgs_new::SpawnModelRequest_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::gazebo_msgs_new::SpawnModelRequest_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::gazebo_msgs_new::SpawnModelRequest_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::gazebo_msgs_new::SpawnModelRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::gazebo_msgs_new::SpawnModelRequest_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::gazebo_msgs_new::SpawnModelRequest_<ContainerAllocator> >
{
  ...
  static const char* value(const ::gazebo_msgs_new::SpawnModelRequest_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x6d0eba5753761cd5ULL;
  static const uint64_t static_value2 = 0x7e6263a056b79930ULL;
};

template<class ContainerAllocator>
struct DataType< ::gazebo_msgs_new::SpawnModelRequest_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::gazebo_msgs_new::SpawnModelRequest_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::gazebo_msgs_new::SpawnModelRequest_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::gazebo_msgs_new::SpawnModelRequest_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::gazebo_msgs_new::SpawnModelRequest_<ContainerAllocator>& v)
  {
    s << indent << "model_name: ";
...
#endif // GAZEBO_MSGS_NEW_MESSAGE_SPAWNMODELREQUEST_H
