// Generated by gencpp from file gazebo_msgs_new/WorldState.msg
// DO NOT EDIT!


#ifndef GAZEBO_MSGS_NEW_MESSAGE_WORLDSTATE_H
#define GAZEBO_MSGS_NEW_MESSAGE_WORLDSTATE_H
...
struct WorldState_
{
  ...
  typedef boost::shared_ptr< ::gazebo_msgs_new::WorldState_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::gazebo_msgs_new::WorldState_<ContainerAllocator> const> ConstPtr;

}; // struct WorldState_

typedef ::gazebo_msgs_new::WorldState_<std::allocator<void> > WorldState;

typedef boost::shared_ptr< ::gazebo_msgs_new::WorldState > WorldStatePtr;
typedef boost::shared_ptr< ::gazebo_msgs_new::WorldState const> WorldStateConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::gazebo_msgs_new::WorldState_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::gazebo_msgs_new::WorldState_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::gazebo_msgs_new::WorldState_<ContainerAllocator1> & lhs, const ::gazebo_msgs_new::WorldState_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::gazebo_msgs_new::WorldState_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::gazebo_msgs_new::WorldState_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::gazebo_msgs_new::WorldState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::gazebo_msgs_new::WorldState_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::gazebo_msgs_new::WorldState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::gazebo_msgs_new::WorldState_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::gazebo_msgs_new::WorldState_<ContainerAllocator> >
{
  ...
  static const char* value(const ::gazebo_msgs_new::WorldState_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xde1a9de3ab7ba97aULL;
  static const uint64_t static_value2 = 0xc0e9ec01a4eb481eULL;
};

template<class ContainerAllocator>
struct DataType< ::gazebo_msgs_new::WorldState_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::gazebo_msgs_new::WorldState_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::gazebo_msgs_new::WorldState_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::gazebo_msgs_new::WorldState_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::gazebo_msgs_new::WorldState_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // GAZEBO_MSGS_NEW_MESSAGE_WORLDSTATE_H
