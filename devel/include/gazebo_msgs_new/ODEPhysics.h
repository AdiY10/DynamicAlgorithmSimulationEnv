// Generated by gencpp from file gazebo_msgs_new/ODEPhysics.msg
// DO NOT EDIT!


#ifndef GAZEBO_MSGS_NEW_MESSAGE_ODEPHYSICS_H
#define GAZEBO_MSGS_NEW_MESSAGE_ODEPHYSICS_H
...
struct ODEPhysics_
{
  ...
  typedef boost::shared_ptr< ::gazebo_msgs_new::ODEPhysics_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::gazebo_msgs_new::ODEPhysics_<ContainerAllocator> const> ConstPtr;

}; // struct ODEPhysics_

typedef ::gazebo_msgs_new::ODEPhysics_<std::allocator<void> > ODEPhysics;

typedef boost::shared_ptr< ::gazebo_msgs_new::ODEPhysics > ODEPhysicsPtr;
typedef boost::shared_ptr< ::gazebo_msgs_new::ODEPhysics const> ODEPhysicsConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::gazebo_msgs_new::ODEPhysics_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::gazebo_msgs_new::ODEPhysics_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::gazebo_msgs_new::ODEPhysics_<ContainerAllocator1> & lhs, const ::gazebo_msgs_new::ODEPhysics_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::gazebo_msgs_new::ODEPhysics_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::gazebo_msgs_new::ODEPhysics_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::gazebo_msgs_new::ODEPhysics_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::gazebo_msgs_new::ODEPhysics_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::gazebo_msgs_new::ODEPhysics_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::gazebo_msgs_new::ODEPhysics_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::gazebo_msgs_new::ODEPhysics_<ContainerAllocator> >
{
  ...
  static const char* value(const ::gazebo_msgs_new::ODEPhysics_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x667d56ddbd547918ULL;
  static const uint64_t static_value2 = 0xc32d1934503dc335ULL;
};

template<class ContainerAllocator>
struct DataType< ::gazebo_msgs_new::ODEPhysics_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::gazebo_msgs_new::ODEPhysics_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::gazebo_msgs_new::ODEPhysics_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::gazebo_msgs_new::ODEPhysics_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::gazebo_msgs_new::ODEPhysics_<ContainerAllocator>& v)
  {
...
#endif // GAZEBO_MSGS_NEW_MESSAGE_ODEPHYSICS_H
