// Generated by gencpp from file gazebo_msgs_new/GetModelPropertiesResponse.msg
// DO NOT EDIT!


#ifndef GAZEBO_MSGS_NEW_MESSAGE_GETMODELPROPERTIESRESPONSE_H
#define GAZEBO_MSGS_NEW_MESSAGE_GETMODELPROPERTIESRESPONSE_H
...
struct GetModelPropertiesResponse_
{
  ...
  typedef boost::shared_ptr< ::gazebo_msgs_new::GetModelPropertiesResponse_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::gazebo_msgs_new::GetModelPropertiesResponse_<ContainerAllocator> const> ConstPtr;

}; // struct GetModelPropertiesResponse_

typedef ::gazebo_msgs_new::GetModelPropertiesResponse_<std::allocator<void> > GetModelPropertiesResponse;

typedef boost::shared_ptr< ::gazebo_msgs_new::GetModelPropertiesResponse > GetModelPropertiesResponsePtr;
typedef boost::shared_ptr< ::gazebo_msgs_new::GetModelPropertiesResponse const> GetModelPropertiesResponseConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::gazebo_msgs_new::GetModelPropertiesResponse_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::gazebo_msgs_new::GetModelPropertiesResponse_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::gazebo_msgs_new::GetModelPropertiesResponse_<ContainerAllocator1> & lhs, const ::gazebo_msgs_new::GetModelPropertiesResponse_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::gazebo_msgs_new::GetModelPropertiesResponse_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::gazebo_msgs_new::GetModelPropertiesResponse_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::gazebo_msgs_new::GetModelPropertiesResponse_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::gazebo_msgs_new::GetModelPropertiesResponse_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::gazebo_msgs_new::GetModelPropertiesResponse_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::gazebo_msgs_new::GetModelPropertiesResponse_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::gazebo_msgs_new::GetModelPropertiesResponse_<ContainerAllocator> >
{
  ...
  static const char* value(const ::gazebo_msgs_new::GetModelPropertiesResponse_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xb7f370938ef77b46ULL;
  static const uint64_t static_value2 = 0x4b95f1bab3ec5028ULL;
};

template<class ContainerAllocator>
struct DataType< ::gazebo_msgs_new::GetModelPropertiesResponse_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::gazebo_msgs_new::GetModelPropertiesResponse_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::gazebo_msgs_new::GetModelPropertiesResponse_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::gazebo_msgs_new::GetModelPropertiesResponse_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::gazebo_msgs_new::GetModelPropertiesResponse_<ContainerAllocator>& v)
  {
...
#endif // GAZEBO_MSGS_NEW_MESSAGE_GETMODELPROPERTIESRESPONSE_H
