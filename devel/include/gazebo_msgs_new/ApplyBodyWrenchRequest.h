// Generated by gencpp from file gazebo_msgs_new/ApplyBodyWrenchRequest.msg
// DO NOT EDIT!


#ifndef GAZEBO_MSGS_NEW_MESSAGE_APPLYBODYWRENCHREQUEST_H
#define GAZEBO_MSGS_NEW_MESSAGE_APPLYBODYWRENCHREQUEST_H
...
struct ApplyBodyWrenchRequest_
{
  ...
  typedef boost::shared_ptr< ::gazebo_msgs_new::ApplyBodyWrenchRequest_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::gazebo_msgs_new::ApplyBodyWrenchRequest_<ContainerAllocator> const> ConstPtr;

}; // struct ApplyBodyWrenchRequest_

typedef ::gazebo_msgs_new::ApplyBodyWrenchRequest_<std::allocator<void> > ApplyBodyWrenchRequest;

typedef boost::shared_ptr< ::gazebo_msgs_new::ApplyBodyWrenchRequest > ApplyBodyWrenchRequestPtr;
typedef boost::shared_ptr< ::gazebo_msgs_new::ApplyBodyWrenchRequest const> ApplyBodyWrenchRequestConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::gazebo_msgs_new::ApplyBodyWrenchRequest_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::gazebo_msgs_new::ApplyBodyWrenchRequest_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::gazebo_msgs_new::ApplyBodyWrenchRequest_<ContainerAllocator1> & lhs, const ::gazebo_msgs_new::ApplyBodyWrenchRequest_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::gazebo_msgs_new::ApplyBodyWrenchRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::gazebo_msgs_new::ApplyBodyWrenchRequest_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::gazebo_msgs_new::ApplyBodyWrenchRequest_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::gazebo_msgs_new::ApplyBodyWrenchRequest_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::gazebo_msgs_new::ApplyBodyWrenchRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::gazebo_msgs_new::ApplyBodyWrenchRequest_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::gazebo_msgs_new::ApplyBodyWrenchRequest_<ContainerAllocator> >
{
  ...
  static const char* value(const ::gazebo_msgs_new::ApplyBodyWrenchRequest_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xe37e6adf97eba509ULL;
  static const uint64_t static_value2 = 0x5baa77dffb71e5bdULL;
};

template<class ContainerAllocator>
struct DataType< ::gazebo_msgs_new::ApplyBodyWrenchRequest_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::gazebo_msgs_new::ApplyBodyWrenchRequest_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::gazebo_msgs_new::ApplyBodyWrenchRequest_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::gazebo_msgs_new::ApplyBodyWrenchRequest_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::gazebo_msgs_new::ApplyBodyWrenchRequest_<ContainerAllocator>& v)
  {
    s << indent << "body_name: ";
...
#endif // GAZEBO_MSGS_NEW_MESSAGE_APPLYBODYWRENCHREQUEST_H
