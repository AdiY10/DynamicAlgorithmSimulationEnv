// Generated by gencpp from file robotnik_msgs_new/QueryAlarm.msg
// DO NOT EDIT!


#ifndef ROBOTNIK_MSGS_NEW_MESSAGE_QUERYALARM_H
#define ROBOTNIK_MSGS_NEW_MESSAGE_QUERYALARM_H
...
struct QueryAlarm_
{
  ...
  typedef boost::shared_ptr< ::robotnik_msgs_new::QueryAlarm_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::robotnik_msgs_new::QueryAlarm_<ContainerAllocator> const> ConstPtr;

}; // struct QueryAlarm_

typedef ::robotnik_msgs_new::QueryAlarm_<std::allocator<void> > QueryAlarm;

typedef boost::shared_ptr< ::robotnik_msgs_new::QueryAlarm > QueryAlarmPtr;
typedef boost::shared_ptr< ::robotnik_msgs_new::QueryAlarm const> QueryAlarmConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::robotnik_msgs_new::QueryAlarm_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::robotnik_msgs_new::QueryAlarm_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::robotnik_msgs_new::QueryAlarm_<ContainerAllocator1> & lhs, const ::robotnik_msgs_new::QueryAlarm_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::robotnik_msgs_new::QueryAlarm_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::robotnik_msgs_new::QueryAlarm_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::robotnik_msgs_new::QueryAlarm_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::robotnik_msgs_new::QueryAlarm_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::robotnik_msgs_new::QueryAlarm_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::robotnik_msgs_new::QueryAlarm_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::robotnik_msgs_new::QueryAlarm_<ContainerAllocator> >
{
  ...
  static const char* value(const ::robotnik_msgs_new::QueryAlarm_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xf3c7e9979cb91a05ULL;
  static const uint64_t static_value2 = 0x0b98067ffb98adffULL;
};

template<class ContainerAllocator>
struct DataType< ::robotnik_msgs_new::QueryAlarm_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::robotnik_msgs_new::QueryAlarm_<ContainerAllocator> >
{
  static const char* value()
  {
    return "int32 alm_id\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::robotnik_msgs_new::QueryAlarm_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::robotnik_msgs_new::QueryAlarm_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::robotnik_msgs_new::QueryAlarm_<ContainerAllocator>& v)
  {
    s << indent << "alm_id: ";
...
#endif // ROBOTNIK_MSGS_NEW_MESSAGE_QUERYALARM_H
