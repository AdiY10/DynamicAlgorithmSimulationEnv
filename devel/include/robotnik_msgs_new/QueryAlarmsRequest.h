// Generated by gencpp from file robotnik_msgs_new/QueryAlarmsRequest.msg
// DO NOT EDIT!


#ifndef ROBOTNIK_MSGS_NEW_MESSAGE_QUERYALARMSREQUEST_H
#define ROBOTNIK_MSGS_NEW_MESSAGE_QUERYALARMSREQUEST_H
...
// reducing the odds to have name collisions with Windows.h 
  ...
  typedef boost::shared_ptr< ::robotnik_msgs_new::QueryAlarmsRequest_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::robotnik_msgs_new::QueryAlarmsRequest_<ContainerAllocator> const> ConstPtr;

}; // struct QueryAlarmsRequest_

typedef ::robotnik_msgs_new::QueryAlarmsRequest_<std::allocator<void> > QueryAlarmsRequest;

typedef boost::shared_ptr< ::robotnik_msgs_new::QueryAlarmsRequest > QueryAlarmsRequestPtr;
typedef boost::shared_ptr< ::robotnik_msgs_new::QueryAlarmsRequest const> QueryAlarmsRequestConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::robotnik_msgs_new::QueryAlarmsRequest_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::robotnik_msgs_new::QueryAlarmsRequest_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::robotnik_msgs_new::QueryAlarmsRequest_<ContainerAllocator1> & lhs, const ::robotnik_msgs_new::QueryAlarmsRequest_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::robotnik_msgs_new::QueryAlarmsRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::robotnik_msgs_new::QueryAlarmsRequest_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::robotnik_msgs_new::QueryAlarmsRequest_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::robotnik_msgs_new::QueryAlarmsRequest_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::robotnik_msgs_new::QueryAlarmsRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::robotnik_msgs_new::QueryAlarmsRequest_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::robotnik_msgs_new::QueryAlarmsRequest_<ContainerAllocator> >
{
  ...
  static const char* value(const ::robotnik_msgs_new::QueryAlarmsRequest_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xf1be883ec4718e11ULL;
  static const uint64_t static_value2 = 0x84241817a2fe2b57ULL;
};

template<class ContainerAllocator>
struct DataType< ::robotnik_msgs_new::QueryAlarmsRequest_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::robotnik_msgs_new::QueryAlarmsRequest_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::robotnik_msgs_new::QueryAlarmsRequest_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::robotnik_msgs_new::QueryAlarmsRequest_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::robotnik_msgs_new::QueryAlarmsRequest_<ContainerAllocator>& v)
  {
    s << indent << "type_query: ";
...
#endif // ROBOTNIK_MSGS_NEW_MESSAGE_QUERYALARMSREQUEST_H
