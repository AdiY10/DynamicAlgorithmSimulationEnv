// Generated by gencpp from file robotnik_msgs_new/Data.msg
// DO NOT EDIT!


#ifndef ROBOTNIK_MSGS_NEW_MESSAGE_DATA_H
#define ROBOTNIK_MSGS_NEW_MESSAGE_DATA_H
...
struct Data_
{
  ...
  typedef boost::shared_ptr< ::robotnik_msgs_new::Data_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::robotnik_msgs_new::Data_<ContainerAllocator> const> ConstPtr;

}; // struct Data_

typedef ::robotnik_msgs_new::Data_<std::allocator<void> > Data;

typedef boost::shared_ptr< ::robotnik_msgs_new::Data > DataPtr;
typedef boost::shared_ptr< ::robotnik_msgs_new::Data const> DataConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::robotnik_msgs_new::Data_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::robotnik_msgs_new::Data_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::robotnik_msgs_new::Data_<ContainerAllocator1> & lhs, const ::robotnik_msgs_new::Data_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::robotnik_msgs_new::Data_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::robotnik_msgs_new::Data_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::robotnik_msgs_new::Data_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::robotnik_msgs_new::Data_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::robotnik_msgs_new::Data_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::robotnik_msgs_new::Data_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::robotnik_msgs_new::Data_<ContainerAllocator> >
{
  ...
  static const char* value(const ::robotnik_msgs_new::Data_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xbeae478f52d7795fULL;
  static const uint64_t static_value2 = 0x673d8edc9e4295a2ULL;
};

template<class ContainerAllocator>
struct DataType< ::robotnik_msgs_new::Data_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::robotnik_msgs_new::Data_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::robotnik_msgs_new::Data_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::robotnik_msgs_new::Data_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::robotnik_msgs_new::Data_<ContainerAllocator>& v)
  {
    s << indent << "interface: ";
...
#endif // ROBOTNIK_MSGS_NEW_MESSAGE_DATA_H
