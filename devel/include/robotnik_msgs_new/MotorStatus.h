// Generated by gencpp from file robotnik_msgs_new/MotorStatus.msg
// DO NOT EDIT!


#ifndef ROBOTNIK_MSGS_NEW_MESSAGE_MOTORSTATUS_H
#define ROBOTNIK_MSGS_NEW_MESSAGE_MOTORSTATUS_H
...
struct MotorStatus_
{
  ...
  typedef boost::shared_ptr< ::robotnik_msgs_new::MotorStatus_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::robotnik_msgs_new::MotorStatus_<ContainerAllocator> const> ConstPtr;

}; // struct MotorStatus_

typedef ::robotnik_msgs_new::MotorStatus_<std::allocator<void> > MotorStatus;

typedef boost::shared_ptr< ::robotnik_msgs_new::MotorStatus > MotorStatusPtr;
typedef boost::shared_ptr< ::robotnik_msgs_new::MotorStatus const> MotorStatusConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::robotnik_msgs_new::MotorStatus_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::robotnik_msgs_new::MotorStatus_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::robotnik_msgs_new::MotorStatus_<ContainerAllocator1> & lhs, const ::robotnik_msgs_new::MotorStatus_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::robotnik_msgs_new::MotorStatus_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::robotnik_msgs_new::MotorStatus_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::robotnik_msgs_new::MotorStatus_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::robotnik_msgs_new::MotorStatus_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::robotnik_msgs_new::MotorStatus_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::robotnik_msgs_new::MotorStatus_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::robotnik_msgs_new::MotorStatus_<ContainerAllocator> >
{
  ...
  static const char* value(const ::robotnik_msgs_new::MotorStatus_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xbee7a4674a1d6970ULL;
  static const uint64_t static_value2 = 0x3bedee2437db3d94ULL;
};

template<class ContainerAllocator>
struct DataType< ::robotnik_msgs_new::MotorStatus_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::robotnik_msgs_new::MotorStatus_<ContainerAllocator> >
{
  static const char* value()
  {
    return "string state\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::robotnik_msgs_new::MotorStatus_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::robotnik_msgs_new::MotorStatus_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::robotnik_msgs_new::MotorStatus_<ContainerAllocator>& v)
  {
    s << indent << "state: ";
...
#endif // ROBOTNIK_MSGS_NEW_MESSAGE_MOTORSTATUS_H
