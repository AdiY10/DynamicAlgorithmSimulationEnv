// Generated by gencpp from file robotnik_msgs_new/ElevatorStatus.msg
// DO NOT EDIT!


#ifndef ROBOTNIK_MSGS_NEW_MESSAGE_ELEVATORSTATUS_H
#define ROBOTNIK_MSGS_NEW_MESSAGE_ELEVATORSTATUS_H
...
// reducing the odds to have name collisions with Windows.h 
  ...
  typedef boost::shared_ptr< ::robotnik_msgs_new::ElevatorStatus_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::robotnik_msgs_new::ElevatorStatus_<ContainerAllocator> const> ConstPtr;

}; // struct ElevatorStatus_

typedef ::robotnik_msgs_new::ElevatorStatus_<std::allocator<void> > ElevatorStatus;

typedef boost::shared_ptr< ::robotnik_msgs_new::ElevatorStatus > ElevatorStatusPtr;
typedef boost::shared_ptr< ::robotnik_msgs_new::ElevatorStatus const> ElevatorStatusConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::robotnik_msgs_new::ElevatorStatus_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::robotnik_msgs_new::ElevatorStatus_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::robotnik_msgs_new::ElevatorStatus_<ContainerAllocator1> & lhs, const ::robotnik_msgs_new::ElevatorStatus_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::robotnik_msgs_new::ElevatorStatus_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::robotnik_msgs_new::ElevatorStatus_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::robotnik_msgs_new::ElevatorStatus_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::robotnik_msgs_new::ElevatorStatus_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::robotnik_msgs_new::ElevatorStatus_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::robotnik_msgs_new::ElevatorStatus_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::robotnik_msgs_new::ElevatorStatus_<ContainerAllocator> >
{
  ...
  static const char* value(const ::robotnik_msgs_new::ElevatorStatus_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x4718bff9866c7290ULL;
  static const uint64_t static_value2 = 0x31e595e6565fdb82ULL;
};

template<class ContainerAllocator>
struct DataType< ::robotnik_msgs_new::ElevatorStatus_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::robotnik_msgs_new::ElevatorStatus_<ContainerAllocator> >
{
  static const char* value()
  {
    return "# state\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::robotnik_msgs_new::ElevatorStatus_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::robotnik_msgs_new::ElevatorStatus_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::robotnik_msgs_new::ElevatorStatus_<ContainerAllocator>& v)
  {
    s << indent << "state: ";
...
#endif // ROBOTNIK_MSGS_NEW_MESSAGE_ELEVATORSTATUS_H
