...
"""autogenerated by genpy from robotnik_msgs_new/GetMotorsHeadingOffsetRequest.msg. Do not edit."""
import codecs
import sys
...
class GetMotorsHeadingOffsetRequest(genpy.Message):
  ...
  _type = "robotnik_msgs_new/GetMotorsHeadingOffsetRequest"
...
def _get_struct_I():
    ...
    return _struct_I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from robotnik_msgs_new/GetMotorsHeadingOffsetResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class GetMotorsHeadingOffsetResponse(genpy.Message):
  ...
  _type = "robotnik_msgs_new/GetMotorsHeadingOffsetResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """robotnik_msgs_new/MotorHeadingOffset[] offsets
...
"""
  __slots__ = ['offsets']
  _slot_types = ['robotnik_msgs_new/MotorHeadingOffset[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = robotnik_msgs_new.msg.MotorHeadingOffset()
        _x = val1
        start = end
        end += 12
...
class GetMotorsHeadingOffset(object):
  _type          = 'robotnik_msgs_new/GetMotorsHeadingOffset'
