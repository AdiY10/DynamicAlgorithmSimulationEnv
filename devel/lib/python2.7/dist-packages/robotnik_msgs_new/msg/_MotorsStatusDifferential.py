...
"""autogenerated by genpy from robotnik_msgs_new/MotorsStatusDifferential.msg. Do not edit."""
import codecs
import sys
...
class MotorsStatusDifferential(genpy.Message):
  ...
  _type = "robotnik_msgs_new/MotorsStatusDifferential"
...
"""
  ...
  _slot_types = ['robotnik_msgs_new/MotorStatus','robotnik_msgs_new/MotorStatus']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.lwStatus is None:
        self.lwStatus = robotnik_msgs_new.msg.MotorStatus()
      if self.rwStatus is None:
        self.rwStatus = robotnik_msgs_new.msg.MotorStatus()
    else:
      self.lwStatus = robotnik_msgs_new.msg.MotorStatus()
      self.rwStatus = robotnik_msgs_new.msg.MotorStatus()
