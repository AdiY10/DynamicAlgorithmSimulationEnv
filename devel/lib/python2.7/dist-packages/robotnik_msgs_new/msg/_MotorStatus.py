...
"""autogenerated by genpy from robotnik_msgs_new/MotorStatus.msg. Do not edit."""
import codecs
import sys
...
class MotorStatus(genpy.Message):
  _md5sum = "bee7a4674a1d69703bedee2437db3d94"
  _type = "robotnik_msgs_new/MotorStatus"
...
"""
  __slots__ = ['state','status','communicationstatus','statusword','driveflags','activestatusword','activedriveflags','digitaloutputs','digitalinputs','averagecurrent','analoginputs']
  _slot_types = ['string','string','string','string','string','string[]','string[]','int32','int32','float32','float32[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       state,status,communicationstatus,statusword,driveflags,activestatusword,activedriveflags,digitaloutputs,digitalinputs,averagecurrent,analoginputs
    ...
    if args or kwds:
      ...
      if self.averagecurrent is None:
