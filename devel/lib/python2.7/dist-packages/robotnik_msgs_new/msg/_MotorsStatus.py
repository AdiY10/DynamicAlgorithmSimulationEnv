...
"""autogenerated by genpy from robotnik_msgs_new/MotorsStatus.msg. Do not edit."""
import codecs
import sys
...
import robotnik_msgs_new.msg

class MotorsStatus(genpy.Message):
  _md5sum = "13ca5dbe99a46066055ab0b75c2f2de7"
  _type = "robotnik_msgs_new/MotorsStatus"
...
"""
  ...
  _slot_types = ['robotnik_msgs_new/MotorStatus','robotnik_msgs_new/MotorStatus','robotnik_msgs_new/MotorStatus','robotnik_msgs_new/MotorStatus']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.flwStatus is None:
        self.flwStatus = robotnik_msgs_new.msg.MotorStatus()
      if self.blwStatus is None:
        self.blwStatus = robotnik_msgs_new.msg.MotorStatus()
      if self.frwStatus is None:
        self.frwStatus = robotnik_msgs_new.msg.MotorStatus()
      if self.brwStatus is None:
        self.brwStatus = robotnik_msgs_new.msg.MotorStatus()
    else:
      self.flwStatus = robotnik_msgs_new.msg.MotorStatus()
      self.blwStatus = robotnik_msgs_new.msg.MotorStatus()
      self.frwStatus = robotnik_msgs_new.msg.MotorStatus()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.flwStatus.activedriveflags:
        ...
        buff.write(struct.Struct('<I%ss'%length).pack(length, val1))
      _x = self
      buff.write(_get_struct_2if().pack(_x.flwStatus.digitaloutputs, _x.flwStatus.digitalinputs, _x.flwStatus.averagecurrent))
      ...
      for val1 in self.blwStatus.activedriveflags:
        ...
        buff.write(struct.Struct('<I%ss'%length).pack(length, val1))
      _x = self
      buff.write(_get_struct_2if().pack(_x.blwStatus.digitaloutputs, _x.blwStatus.digitalinputs, _x.blwStatus.averagecurrent))
      ...
      for val1 in self.frwStatus.activedriveflags:
        ...
        buff.write(struct.Struct('<I%ss'%length).pack(length, val1))
      _x = self
      buff.write(_get_struct_2if().pack(_x.frwStatus.digitaloutputs, _x.frwStatus.digitalinputs, _x.frwStatus.averagecurrent))
      ...
      for val1 in self.brwStatus.activedriveflags:
        ...
        buff.write(struct.Struct('<I%ss'%length).pack(length, val1))
      _x = self
      buff.write(_get_struct_2if().pack(_x.brwStatus.digitaloutputs, _x.brwStatus.digitalinputs, _x.brwStatus.averagecurrent))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.flwStatus.digitaloutputs, _x.flwStatus.digitalinputs, _x.flwStatus.averagecurrent,) = _get_struct_2if().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
      ...
      (_x.blwStatus.digitaloutputs, _x.blwStatus.digitalinputs, _x.blwStatus.averagecurrent,) = _get_struct_2if().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
      ...
      (_x.frwStatus.digitaloutputs, _x.frwStatus.digitalinputs, _x.frwStatus.averagecurrent,) = _get_struct_2if().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
      ...
      (_x.brwStatus.digitaloutputs, _x.brwStatus.digitalinputs, _x.brwStatus.averagecurrent,) = _get_struct_2if().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
