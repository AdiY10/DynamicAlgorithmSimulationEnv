...
"""autogenerated by genpy from robotnik_msgs_new/SetElevatorResult.msg. Do not edit."""
import codecs
import sys
...
class SetElevatorResult(genpy.Message):
  ...
  _type = "robotnik_msgs_new/SetElevatorResult"
...
"""
  ...
  _slot_types = ['bool','robotnik_msgs_new/ElevatorStatus']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.status is None:
        self.status = robotnik_msgs_new.msg.ElevatorStatus()
    else:
      self.result = False
      self.status = robotnik_msgs_new.msg.ElevatorStatus()
