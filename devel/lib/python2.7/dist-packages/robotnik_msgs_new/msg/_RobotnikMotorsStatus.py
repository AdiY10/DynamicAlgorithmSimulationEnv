...
"""autogenerated by genpy from robotnik_msgs_new/RobotnikMotorsStatus.msg. Do not edit."""
import codecs
import sys
...
class RobotnikMotorsStatus(genpy.Message):
  ...
  _type = "robotnik_msgs_new/RobotnikMotorsStatus"
...
"""
  ...
  _slot_types = ['string[]','int32[]','robotnik_msgs_new/MotorStatus[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.motor_status = []
      for i in range(0, length):
        val1 = robotnik_msgs_new.msg.MotorStatus()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
