...
"""autogenerated by genpy from robotnik_msgs_new/SafetyModuleStatus.msg. Do not edit."""
import codecs
import sys
...
class SafetyModuleStatus(genpy.Message):
  ...
  _type = "robotnik_msgs_new/SafetyModuleStatus"
...
"""
  ...
  _slot_types = ['string','bool','bool','bool','bool','bool','float64','float64','robotnik_msgs_new/LaserMode','robotnik_msgs_new/LaserStatus[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.lasers_mode is None:
        self.lasers_mode = robotnik_msgs_new.msg.LaserMode()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = robotnik_msgs_new.msg.LaserStatus()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
