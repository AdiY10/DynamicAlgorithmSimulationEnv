...
"""autogenerated by genpy from robotnik_msgs_new/Interfaces.msg. Do not edit."""
import codecs
import sys
...
class Interfaces(genpy.Message):
  ...
  _type = "robotnik_msgs_new/Interfaces"
...
"""
  ...
  _slot_types = ['robotnik_msgs_new/Data','robotnik_msgs_new/Data[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.total is None:
        self.total = robotnik_msgs_new.msg.Data()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = robotnik_msgs_new.msg.Data()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
