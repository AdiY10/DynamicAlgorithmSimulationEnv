...
"""autogenerated by genpy from gazebo_msgs_new/GetPhysicsPropertiesRequest.msg. Do not edit."""
import codecs
import sys
...
class GetPhysicsPropertiesRequest(genpy.Message):
  ...
  _type = "gazebo_msgs_new/GetPhysicsPropertiesRequest"
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetPhysicsPropertiesRequest, self).__init__(*args, **kwds)
...
def _get_struct_I():
    ...
    return _struct_I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from gazebo_msgs_new/GetPhysicsPropertiesResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class GetPhysicsPropertiesResponse(genpy.Message):
  _md5sum = "575a5e74786981b7df2e3afc567693a6"
  _type = "gazebo_msgs_new/GetPhysicsPropertiesResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """# sets pose and twist of a link.  All children link poses/twists of the URDF tree will be updated accordingly
...
"""
  ...
  _slot_types = ['float64','bool','float64','geometry_msgs/Vector3','gazebo_msgs_new/ODEPhysics','bool','string']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetPhysicsPropertiesResponse, self).__init__(*args, **kwds)
      ...
      if self.ode_config is None:
        self.ode_config = gazebo_msgs_new.msg.ODEPhysics()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.time_step, _x.pause, _x.max_update_rate, _x.gravity.x, _x.gravity.y, _x.gravity.z, _x.ode_config.auto_disable_bodies, _x.ode_config.sor_pgs_precon_iters, _x.ode_config.sor_pgs_iters, _x.ode_config.sor_pgs_w, _x.ode_config.sor_pgs_rms_error_tol, _x.ode_config.contact_surface_layer, _x.ode_config.contact_max_correcting_vel, _x.ode_config.cfm, _x.ode_config.erp, _x.ode_config.max_contacts, _x.success,) = _get_struct_dB4dB2I6dIB().unpack(str[start:end])
...
def _get_struct_I():
    global _struct_I
    return _struct_I
_struct_dB4dB2I6dIB = None
def _get_struct_dB4dB2I6dIB():
    global _struct_dB4dB2I6dIB
    if _struct_dB4dB2I6dIB is None:
        _struct_dB4dB2I6dIB = struct.Struct("<dB4dB2I6dIB")
    return _struct_dB4dB2I6dIB
class GetPhysicsProperties(object):
  _type          = 'gazebo_msgs_new/GetPhysicsProperties'
  _md5sum = '575a5e74786981b7df2e3afc567693a6'
