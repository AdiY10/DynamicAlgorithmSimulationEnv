...
"""autogenerated by genpy from gazebo_msgs_new/SetJointPropertiesRequest.msg. Do not edit."""
import codecs
import sys
...
"""
  ...
  _slot_types = ['string','gazebo_msgs_new/ODEJointProperties']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.ode_joint_config is None:
        self.ode_joint_config = gazebo_msgs_new.msg.ODEJointProperties()
    else:
      self.joint_name = ''
      self.ode_joint_config = gazebo_msgs_new.msg.ODEJointProperties()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.ode_joint_config.damping))
      length = len(self.ode_joint_config.hiStop)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.ode_joint_config.hiStop))
      length = len(self.ode_joint_config.loStop)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.ode_joint_config.loStop))
      length = len(self.ode_joint_config.erp)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.ode_joint_config.erp))
      length = len(self.ode_joint_config.cfm)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.ode_joint_config.cfm))
      length = len(self.ode_joint_config.stop_erp)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.ode_joint_config.stop_erp))
      length = len(self.ode_joint_config.stop_cfm)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.ode_joint_config.stop_cfm))
      length = len(self.ode_joint_config.fudge_factor)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.ode_joint_config.fudge_factor))
      length = len(self.ode_joint_config.fmax)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.ode_joint_config.fmax))
      length = len(self.ode_joint_config.vel)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.ode_joint_config.vel))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.ode_joint_config.damping = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.ode_joint_config.hiStop = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.ode_joint_config.loStop = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.ode_joint_config.erp = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.ode_joint_config.cfm = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.ode_joint_config.stop_erp = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.ode_joint_config.stop_cfm = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.ode_joint_config.fudge_factor = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.ode_joint_config.fmax = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.ode_joint_config.vel = s.unpack(str[start:end])
      return self
...
def _get_struct_I():
    ...
    return _struct_I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from gazebo_msgs_new/SetJointPropertiesResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class SetJointPropertiesResponse(genpy.Message):
  ...
  _type = "gazebo_msgs_new/SetJointPropertiesResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
class SetJointProperties(object):
  _type          = 'gazebo_msgs_new/SetJointProperties'
