...
"""autogenerated by genpy from gazebo_msgs_new/GetLinkStateRequest.msg. Do not edit."""
import codecs
import sys
...
class GetLinkStateRequest(genpy.Message):
  ...
  _type = "gazebo_msgs_new/GetLinkStateRequest"
...
def _get_struct_I():
    ...
    return _struct_I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from gazebo_msgs_new/GetLinkStateResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class GetLinkStateResponse(genpy.Message):
  ...
  _type = "gazebo_msgs_new/GetLinkStateResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """gazebo_msgs_new/LinkState link_state
...
float64 z"""
  ...
  _slot_types = ['gazebo_msgs_new/LinkState','bool','string']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.link_state is None:
        self.link_state = gazebo_msgs_new.msg.LinkState()
...
class GetLinkState(object):
  _type          = 'gazebo_msgs_new/GetLinkState'
