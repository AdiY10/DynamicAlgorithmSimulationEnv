...
"""autogenerated by genpy from gazebo_msgs_new/ContactsState.msg. Do not edit."""
import codecs
import sys
...
class ContactsState(genpy.Message):
  ...
  _type = "gazebo_msgs_new/ContactsState"
...
float64 z"""
  ...
  _slot_types = ['std_msgs/Header','gazebo_msgs_new/ContactState[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = gazebo_msgs_new.msg.ContactState()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
        ...
        if python3:
          val1.collision1_name = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          val1.collision2_name = str[start:end].decode('utf-8', 'rosmsg')
        else:
