...
"""autogenerated by genpy from gazebo_msgs_new/ContactState.msg. Do not edit."""
import codecs
import sys
...
class ContactState(genpy.Message):
  ...
  _type = "gazebo_msgs_new/ContactState"
...
float64 z"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.collision1_name = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.collision2_name = str[start:end].decode('utf-8', 'rosmsg')
      else:
