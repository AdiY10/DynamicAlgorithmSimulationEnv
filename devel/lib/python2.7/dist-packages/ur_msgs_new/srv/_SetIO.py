...
"""autogenerated by genpy from ur_msgs_new/SetIORequest.msg. Do not edit."""
import codecs
import sys
...
class SetIORequest(genpy.Message):
  ...
  _type = "ur_msgs_new/SetIORequest"
...
def _get_struct_2bf():
    ...
    return _struct_2bf
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from ur_msgs_new/SetIOResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class SetIOResponse(genpy.Message):
  ...
  _type = "ur_msgs_new/SetIOResponse"
  _has_header = False  # flag to mark the presence of a Header object
