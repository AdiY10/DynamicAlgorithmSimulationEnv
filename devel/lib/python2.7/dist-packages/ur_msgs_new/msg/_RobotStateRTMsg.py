...
"""autogenerated by genpy from ur_msgs_new/RobotStateRTMsg.msg. Do not edit."""
import codecs
import sys
...
class RobotStateRTMsg(genpy.Message):
  ...
  _type = "ur_msgs_new/RobotStateRTMsg"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.tool_vector))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.tool_vector = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
